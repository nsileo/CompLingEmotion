...
for user in set(data["#AUTHID"]):
    ...
    rf_reg_e = make_pipeline(StandardScaler(), SVC(gamma='auto'))
    ...
    rf_reg_o = make_pipeline(StandardScaler(), SVC(gamma='auto'))
    ...
    rf_reg_a = make_pipeline(StandardScaler(), SVC(gamma='auto'))
    ...
    rf_reg_c = make_pipeline(StandardScaler(), SVC(gamma='auto'))
    ...
    rf_reg_n = make_pipeline(StandardScaler(), SVC(gamma='auto'))
...
results_emo_lem.to_csv('results_emo_lem_SVM.csv')