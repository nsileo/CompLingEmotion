...
class NRCLex:
    ...
    stems_lexicon = {'abduct': ['fear', 'negative', 'sadness', 'surprise'], 'aberr': ['negative'],
                     'abhorr': ['anger', 'disgust', 'fear', 'negative'], 'abil': ['positive'],
                     'abnorm': ['disgust', 'negative'], 'abolit': ['negative'],
                     'abomin': ['disgust', 'fear', 'negative'], 'abovement': ['positive'], 'abras': ['negative'],
                     'abrog': ['negative'], 'absenc': ['fear', 'negative', 'sadness'],
                     'absente': ['negative', 'sadness'], 'absolut': ['positive'], 'absorb': ['positive'],
                     'abund': ['anticipation', 'disgust', 'joy', 'negative', 'positive', 'trust'],
                     'abus': ['anger', 'disgust', 'fear', 'negative', 'sadness'], 'abysm': ['negative', 'sadness'],
                     'academ': ['positive', 'trust'], 'academi': ['positive'], 'acceler': ['anticipation'],
                     'accept': ['positive'], 'access': ['positive'],
                     'accid': ['fear', 'negative', 'sadness', 'surprise'],
                     'accolad': ['anticipation', 'joy', 'positive', 'surprise', 'trust'], 'accommod': ['positive'],
                     'accompani': ['anticipation', 'joy', 'positive', 'trust'], 'accredit': ['positive', 'trust'],
                     'accur': ['positive', 'trust'], 'accurs': ['anger', 'fear', 'negative', 'sadness'],
                     'accus': ['anger', 'disgust', 'negative'], 'ach': ['negative', 'sadness'],
                     'achiev': ['joy', 'positive', 'trust'], 'acknowledg': ['positive'], 'acquir': ['positive'],
                     'acuiti': ['positive'], 'addict': ['negative'], 'address': ['anticipation', 'positive'],
                     'adequaci': ['positive'], 'adher': ['trust'], 'adipos': ['negative'],
                     'adjud': ['fear', 'negative'], 'administr': ['trust'], 'admir': ['joy', 'positive', 'trust'],
                     'admiss': ['positive', 'trust'], 'admonit': ['fear', 'negative'], 'ador': ['joy', 'positive'],
                     'adulter': ['negative'], 'adulteri': ['disgust', 'negative', 'sadness'],
                     'advanc': ['anticipation', 'fear', 'joy', 'positive', 'surprise'], 'advantag': ['positive'],
                     'adventur': ['anticipation', 'positive'], 'adversari': ['anger', 'negative'],
                     'advers': ['anger', 'disgust', 'fear', 'negative', 'sadness'], 'advic': ['trust'],
                     'advis': ['positive', 'trust'], 'advocaci': ['anger', 'anticipation', 'joy', 'positive', 'trust'],
                     'advoc': ['trust'], 'aesthet': ['positive'], 'affabl': ['positive'],
                     'affect': ['joy', 'positive', 'trust'], 'affili': ['positive'], 'affluenc': ['joy', 'positive'],
                     'aftertast': ['negative'], 'aggrav': ['anger', 'negative'],
                     'aggress': ['anger', 'fear', 'negative'], 'agil': ['positive'], 'agit': ['anger', 'negative'],
                     'agon': ['fear', 'negative'], 'agoni': ['anger', 'fear', 'negative', 'sadness'],
                     'agre': ['positive'], 'agreeabl': ['positive', 'trust'], 'agricultur': ['positive'],
                     'air': ['disgust', 'negative'], 'alabast': ['positive'],
                     'alcohol': ['anger', 'disgust', 'fear', 'negative', 'sadness'],
                     'alert': ['anticipation', 'fear', 'positive', 'surprise'], 'aliment': ['positive'],
                     'alimoni': ['negative'], 'aliv': ['anticipation', 'joy', 'positive', 'trust'],
                     'alleg': ['anger', 'negative'], 'allegi': ['positive', 'trust'], 'allevi': ['positive'],
                     'allianc': ['trust'], 'alli': ['positive', 'trust'], 'allow': ['positive'],
                     'allur': ['anticipation', 'joy', 'positive', 'surprise'], 'almighti': ['positive'],
                     'alterc': ['anger', 'negative'], 'amaz': ['surprise'], 'ambigu': ['negative'],
                     'ambit': ['anticipation', 'joy', 'positive', 'trust'], 'ambul': ['fear', 'trust'],
                     'amelior': ['positive'], 'amiabl': ['positive'], 'amic': ['joy', 'positive'],
                     'amnesti': ['joy', 'positive'], 'amort': ['trust'], 'amphetamin': ['disgust', 'negative'],
                     'amus': ['joy', 'positive'], 'anarch': ['anger', 'fear', 'negative'],
                     'anarchi': ['anger', 'fear', 'negative'], 'ancestr': ['trust'],
                     'anchorag': ['positive', 'sadness'], 'angl': ['anticipation', 'negative'],
                     'angri': ['anger', 'disgust', 'negative'], 'anim': ['positive'],
                     'animos': ['anger', 'disgust', 'fear', 'negative', 'sadness'],
                     'annihil': ['anger', 'fear', 'negative'], 'announc': ['anticipation'],
                     'anomali': ['fear', 'negative', 'surprise'], 'anonym': ['negative'], 'answer': ['trust'],
                     'antagon': ['anger', 'negative'], 'antibiot': ['positive'], 'anticip': ['anticipation'],
                     'anticipatori': ['anticipation'], 'antidot': ['anticipation', 'positive', 'trust'],
                     'antifung': ['positive', 'trust'], 'antipathi': ['anger', 'disgust', 'negative'],
                     'antiqu': ['negative'], 'antisept': ['positive', 'trust'],
                     'antisoci': ['anger', 'disgust', 'fear', 'negative', 'sadness'],
                     'antithesi': ['anger', 'negative'],
                     'anxieti': ['anger', 'anticipation', 'fear', 'negative', 'sadness'], 'apach': ['fear', 'negative'],
                     'apathet': ['negative', 'sadness'], 'apathi': ['negative', 'sadness'],
                     'apologet': ['positive', 'trust'], 'apolog': ['positive', 'sadness', 'trust'],
                     'apostl': ['positive', 'trust'], 'apostol': ['trust'], 'appal': ['disgust', 'fear', 'negative'],
                     'apparit': ['fear', 'surprise'], 'append': ['fear', 'negative', 'sadness'],
                     'applaus': ['joy', 'positive', 'surprise', 'trust'], 'applic': ['anticipation'],
                     'appreci': ['joy', 'positive', 'trust'], 'apprehens': ['fear', 'negative'], 'apprentic': ['trust'],
                     'approach': ['anticipation'], 'approb': ['positive', 'trust'], 'appropri': ['negative'],
                     'approv': ['positive'], 'aptitud': ['positive'], 'arbit': ['trust'], 'arbitr': ['anticipation'],
                     'archaeolog': ['anticipation', 'positive'], 'architectur': ['trust'],
                     'argu': ['anger', 'negative'], 'aristocraci': ['positive'], 'aristocrat': ['positive'],
                     'arm': ['anger', 'fear', 'negative', 'positive'], 'armori': ['trust'],
                     'arous': ['anticipation', 'positive'], 'arraign': ['anger', 'fear', 'negative', 'sadness'],
                     'arrear': ['negative'], 'arriv': ['anticipation'], 'arrog': ['negative'], 'articul': ['positive'],
                     'artilleri': ['fear', 'negative'], 'artist': ['positive'], 'ascend': ['positive'],
                     'asham': ['disgust', 'negative', 'sadness'],
                     'aspir': ['anticipation', 'joy', 'positive', 'surprise', 'trust'],
                     'assembl': ['positive', 'trust'], 'assert': ['positive', 'trust'], 'assess': ['surprise', 'trust'],
                     'asset': ['positive'], 'asshol': ['anger', 'disgust', 'negative'], 'assigne': ['trust'],
                     'associ': ['positive', 'trust'], 'assuag': ['positive'], 'assur': ['positive', 'trust'],
                     'astonish': ['positive', 'surprise'], 'astring': ['negative'],
                     'astrolog': ['anticipation', 'positive'], 'astronom': ['anticipation', 'positive'],
                     'astut': ['positive'], 'asymmetri': ['disgust'], 'atherosclerosi': ['fear', 'negative', 'sadness'],
                     'athlet': ['positive'], 'aton': ['anticipation', 'joy', 'positive', 'trust'],
                     'atroci': ['anger', 'disgust', 'negative'],
                     'atroc': ['anger', 'disgust', 'fear', 'negative', 'sadness'],
                     'atrophi': ['disgust', 'fear', 'negative', 'sadness'], 'attach': ['positive'],
                     'attain': ['anticipation', 'positive'], 'attend': ['anticipation'], 'attent': ['positive'],
                     'attenu': ['negative'], 'attract': ['positive'], 'audac': ['negative'],
                     'audienc': ['anticipation'], 'auspici': ['anticipation', 'joy', 'positive'],
                     'auster': ['fear', 'negative', 'sadness'], 'authent': ['joy', 'positive', 'trust'],
                     'authorit': ['positive', 'trust'], 'autocrat': ['negative'], 'automat': ['trust'],
                     'autopsi': ['disgust', 'fear', 'negative', 'sadness'],
                     'avalanch': ['fear', 'negative', 'sadness', 'surprise'],
                     'avaric': ['anger', 'disgust', 'negative'], 'aveng': ['anger', 'negative'],
                     'avers': ['anger', 'disgust', 'fear', 'negative'],
                     'aw': ['anger', 'disgust', 'fear', 'negative', 'sadness'], 'awkward': ['disgust', 'negative'],
                     'awri': ['negative'], 'axiomat': ['trust'], 'babbl': ['negative'], 'babi': ['joy', 'positive'],
                     'babysitt': ['trust'], 'baccalaur': ['positive'], 'backbon': ['anger', 'positive', 'trust'],
                     'backwat': ['negative', 'sadness'], 'badg': ['trust'], 'balanc': ['positive'],
                     'bankruptci': ['anger', 'disgust', 'fear', 'negative', 'sadness'],
                     'banshe': ['anger', 'disgust', 'fear', 'negative', 'sadness'],
                     'barbar': ['anger', 'disgust', 'fear', 'negative'], 'bar': ['negative'],
                     'barricad': ['fear', 'negative'], 'bartend': ['trust'],
                     'basketbal': ['anticipation', 'joy', 'positive'], 'batteri': ['anger', 'negative'],
                     'battl': ['anger', 'negative'], 'bawdi': ['negative'],
                     'beat': ['anger', 'fear', 'negative', 'sadness'], 'beautif': ['joy', 'positive', 'trust'],
                     'beauti': ['joy', 'positive'], 'beautifi': ['joy', 'positive'], 'befal': ['negative'],
                     'befit': ['positive'], 'belat': ['negative'], 'believ': ['trust'],
                     'belittl': ['anger', 'disgust', 'fear', 'negative', 'sadness'],
                     'belliger': ['anger', 'fear', 'negative'], 'bellow': ['anger'], 'benefici': ['positive'],
                     'benevol': ['joy', 'positive', 'trust'], 'bereav': ['negative', 'sadness'],
                     'betroth': ['anticipation', 'joy', 'positive', 'trust'], 'better': ['positive'],
                     'beverag': ['positive'], 'bewar': ['anticipation', 'fear', 'negative'],
                     'bewild': ['fear', 'negative', 'surprise'], 'bewilder': ['fear', 'surprise'],
                     'biblic': ['positive'], 'bicker': ['anger', 'disgust', 'negative'], 'bilingu': ['positive'],
                     'biopsi': ['fear', 'negative'], 'birthplac': ['anger', 'negative'],
                     'bitter': ['anger', 'disgust', 'negative', 'sadness'], 'bizarr': ['negative', 'surprise'],
                     'blasphem': ['anger', 'disgust', 'negative'], 'blasphemi': ['anger', 'negative'],
                     'bleed': ['disgust', 'fear', 'negative', 'sadness'], 'bloat': ['disgust', 'negative'],
                     'blockad': ['anger', 'fear', 'negative', 'sadness'],
                     'bloodsh': ['anger', 'disgust', 'fear', 'negative', 'sadness', 'surprise'],
                     'bloodthirsti': ['anger', 'disgust', 'fear', 'negative'],
                     'bloodi': ['anger', 'disgust', 'fear', 'negative', 'sadness'], 'boilerpl': ['negative'],
                     'boister': ['anger', 'anticipation', 'joy', 'negative', 'positive'],
                     'bondag': ['fear', 'negative', 'sadness'], 'bond': ['negative'], 'bonn': ['positive'],
                     'boobi': ['negative'], 'booz': ['negative'], 'borrow': ['negative'],
                     'bounti': ['anticipation', 'joy', 'positive'], 'bovin': ['disgust', 'negative'],
                     'bowel': ['disgust'], 'box': ['anger'], 'brain': ['positive'], 'brandi': ['negative'],
                     'braveri': ['positive'], 'briberi': ['disgust', 'negative'], 'brigad': ['fear', 'negative'],
                     'bright': ['positive'], 'brimston': ['anger', 'fear', 'negative'], 'bristl': ['negative'],
                     'broadsid': ['anticipation', 'negative'], 'brocad': ['positive'],
                     'bruis': ['anticipation', 'negative'], 'buddi': ['anticipation', 'joy', 'positive', 'trust'],
                     'bugl': ['anticipation'], 'bulli': ['anger', 'fear', 'negative'],
                     'burdensom': ['fear', 'negative', 'sadness'], 'bureaucraci': ['negative', 'trust'],
                     'burglari': ['negative'], 'buri': ['fear', 'negative', 'sadness'],
                     'burk': ['anger', 'disgust', 'fear', 'negative', 'sadness'], 'burlesqu': ['surprise'],
                     'bursari': ['trust'], 'bust': ['anger', 'fear', 'negative'], 'butteri': ['positive'],
                     'cabl': ['surprise'], 'cacophoni': ['anger', 'disgust', 'negative'],
                     'cadav': ['disgust', 'fear', 'negative', 'sadness', 'surprise'], 'calam': ['sadness'],
                     'calcul': ['negative'], 'call': ['anticipation', 'negative', 'trust'], 'camouflag': ['surprise'],
                     'campaign': ['anger', 'fear', 'negative'], 'canari': ['positive'], 'candi': ['positive'],
                     'cannib': ['disgust', 'fear', 'negative'], 'canon': ['trust'],
                     'captiv': ['anticipation', 'joy', 'positive', 'surprise', 'trust'], 'captur': ['negative'],
                     'cardiomyopathi': ['fear', 'negative', 'sadness'], 'care': ['positive'],
                     'careless': ['anger', 'disgust', 'negative'], 'caretak': ['positive', 'trust'],
                     'caricatur': ['negative'], 'cari': ['disgust', 'negative'],
                     'carnag': ['anger', 'disgust', 'fear', 'negative', 'sadness', 'surprise'],
                     'carnivor': ['fear', 'negative'], 'cartridg': ['fear'], 'cascad': ['positive'],
                     'cast': ['negative'], 'casualti': ['anger', 'fear', 'negative', 'sadness'],
                     'catastroph': ['anger', 'disgust', 'fear', 'negative', 'sadness', 'surprise'],
                     'catech': ['disgust'], 'categor': ['positive'], 'cathart': ['positive'],
                     'cathedr': ['joy', 'positive', 'trust'], 'cathet': ['negative'], 'cautionari': ['fear'],
                     'celebr': ['anticipation', 'joy', 'positive'], 'celesti': ['anticipation', 'joy', 'positive'],
                     'cemeteri': ['fear', 'negative', 'sadness'], 'censur': ['negative'], 'cerebr': ['positive'],
                     'ceremoni': ['joy', 'positive', 'surprise'], 'certainti': ['positive'], 'certifi': ['trust'],
                     'cessat': ['negative'], 'chafe': ['negative'], 'challeng': ['anger', 'fear', 'negative'],
                     'chanc': ['surprise'], 'chang': ['fear'], 'changeabl': ['anticipation', 'surprise'],
                     'chao': ['anger', 'fear', 'negative', 'sadness'], 'charad': ['negative'],
                     'chargeabl': ['fear', 'negative', 'sadness'],
                     'charit': ['anticipation', 'joy', 'positive', 'trust'], 'chariti': ['joy', 'positive'],
                     'chastis': ['negative'], 'chastiti': ['anticipation', 'positive', 'trust'],
                     'chatter': ['positive'], 'chatti': ['negative'], 'cheeri': ['anticipation', 'joy', 'positive'],
                     'cheesecak': ['negative'], 'cherri': ['positive'],
                     'chican': ['anticipation', 'negative', 'surprise', 'trust'], 'chilli': ['negative'],
                     'chivalri': ['positive'], 'chocol': ['anticipation', 'joy', 'positive', 'trust'],
                     'choic': ['positive'], 'chronicl': ['positive', 'trust'],
                     'chuckl': ['anticipation', 'joy', 'positive', 'surprise', 'trust'], 'cigarett': ['negative'],
                     'circumcis': ['positive'], 'circumvent': ['negative', 'positive'], 'clairvoy': ['positive'],
                     'clarifi': ['positive'], 'classifi': ['positive'], 'cleanli': ['positive'], 'cleans': ['positive'],
                     'clearanc': ['positive', 'trust'], 'clear': ['positive'], 'cleav': ['fear'],
                     'cleric': ['positive', 'trust'], 'close': ['joy', 'positive', 'trust'],
                     'closur': ['anticipation', 'joy', 'positive', 'sadness'], 'cloth': ['positive'],
                     'cloud': ['negative', 'sadness'], 'cloudi': ['fear', 'negative'],
                     'clumsi': ['disgust', 'negative'], 'coalesc': ['trust'], 'coalit': ['positive'],
                     'cocain': ['negative', 'sadness'], 'coerc': ['anger', 'disgust', 'fear', 'negative'],
                     'cognit': ['positive'], 'coher': ['positive'], 'cohes': ['trust'], 'coincid': ['surprise'],
                     'collabor': ['trust'], 'collaps': ['disgust', 'fear', 'negative', 'sadness'],
                     'collater': ['trust'], 'collect': ['positive', 'trust'], 'collis': ['anger', 'negative'],
                     'collus': ['anger', 'disgust', 'fear', 'negative', 'sadness'], 'coloss': ['positive'],
                     'comatos': ['fear', 'negative', 'sadness'], 'come': ['anticipation'],
                     'command': ['positive', 'trust'], 'commemor': ['anticipation', 'joy', 'positive', 'sadness'],
                     'comment': ['positive'], 'commerc': ['trust'], 'commiss': ['trust'],
                     'committ': ['negative', 'sadness'], 'commit': ['positive', 'trust'], 'committe': ['trust'],
                     'commodor': ['positive', 'trust'], 'commonplac': ['anticipation', 'trust'],
                     'commot': ['anger', 'negative'], 'communic': ['positive', 'trust'], 'communiti': ['positive'],
                     'commut': ['positive'], 'compat': ['positive'], 'compel': ['positive'],
                     'compens': ['anticipation', 'joy', 'positive', 'surprise', 'trust'], 'compensatori': ['positive'],
                     'compet': ['positive', 'trust'], 'competit': ['anticipation', 'negative'], 'complac': ['positive'],
                     'complementari': ['positive'], 'complet': ['positive'], 'complex': ['negative'],
                     'complianc': ['positive', 'trust'], 'complic': ['anger', 'negative'], 'compos': ['positive'],
                     'composur': ['positive'], 'comprehens': ['positive'], 'comptrol': ['trust'],
                     'compuls': ['anger', 'negative'], 'compulsori': ['negative'], 'comrad': ['positive', 'trust'],
                     'concentr': ['positive'], 'concern': ['fear', 'sadness'], 'concili': ['joy', 'positive', 'trust'],
                     'conclud': ['positive'], 'concuss': ['anger', 'negative', 'sadness'], 'condescend': ['negative'],
                     'condescens': ['anger', 'disgust', 'negative', 'sadness'], 'condol': ['positive', 'sadness'],
                     'condon': ['positive'], 'conduc': ['positive'], 'conduct': ['positive'],
                     'confeder': ['positive', 'trust'], 'confid': ['trust'], 'confidenti': ['trust'],
                     'confin': ['anger', 'fear', 'negative', 'sadness'], 'confirm': ['trust'],
                     'confisc': ['anger', 'negative', 'sadness'], 'conflagr': ['anger', 'fear', 'negative'],
                     'conform': ['positive'], 'confus': ['negative'], 'congeni': ['positive'], 'congest': ['negative'],
                     'conglomer': ['trust'], 'congratulatori': ['joy', 'positive'], 'congreg': ['positive', 'trust'],
                     'congruenc': ['positive', 'trust'], 'conjectur': ['anticipation'],
                     'conjur': ['anticipation', 'surprise'], 'connect': ['trust'], 'conscienc': ['positive', 'trust'],
                     'conscienti': ['positive', 'trust'], 'conscious': ['positive'],
                     'consecr': ['anticipation', 'joy', 'positive', 'sadness', 'trust'], 'consequ': ['anticipation'],
                     'conserv': ['anticipation', 'positive', 'trust'], 'consider': ['positive'],
                     'consist': ['positive', 'trust'], 'consol': ['positive', 'sadness'], 'conson': ['positive'],
                     'conspiraci': ['fear'], 'conspir': ['anger', 'anticipation', 'disgust', 'fear', 'negative'],
                     'constabl': ['trust'], 'constanc': ['positive', 'trust'],
                     'constern': ['anger', 'fear', 'negative'], 'constip': ['disgust', 'negative'],
                     'constitut': ['trust'], 'consumm': ['positive'], 'contagi': ['disgust', 'fear', 'negative'],
                     'contamin': ['disgust', 'negative'], 'contempl': ['positive'], 'contemptu': ['anger', 'negative'],
                     'contenti': ['anger', 'disgust', 'fear', 'negative'], 'conting': ['anticipation'],
                     'continu': ['anticipation'], 'contract': ['negative'], 'contradictori': ['negative'],
                     'contrari': ['negative'], 'contrast': ['negative'], 'contraven': ['negative'],
                     'contravent': ['negative'], 'contribut': ['positive'], 'controversi': ['anger', 'negative'],
                     'conveni': ['positive'], 'converg': ['anticipation'], 'convers': ['positive'],
                     'conveyanc': ['trust'], 'convinc': ['anticipation', 'positive', 'trust'], 'cooper': ['positive'],
                     'copi': ['negative'], 'coron': ['joy', 'positive', 'trust'], 'corpor': ['negative'],
                     'corps': ['disgust', 'negative', 'sadness'], 'correct': ['negative'],
                     'correspond': ['anticipation', 'positive'], 'corrobor': ['positive', 'trust'],
                     'corros': ['negative'], 'cors': ['sadness'], 'cosi': ['positive'], 'counti': ['trust'],
                     'courag': ['positive'], 'cours': ['negative'], 'courtesi': ['positive'],
                     'coven': ['positive', 'trust'], 'cowardic': ['fear', 'negative'], 'coyot': ['fear'],
                     'crabbi': ['anger', 'negative'], 'cradl': ['anticipation', 'joy', 'positive', 'trust'],
                     'cranki': ['anger', 'negative'], 'craze': ['anger', 'fear', 'negative'],
                     'crazi': ['anger', 'fear', 'negative', 'sadness'], 'creak': ['negative'],
                     'creat': ['joy', 'positive'], 'creativ': ['positive'], 'creatur': ['disgust', 'fear', 'negative'],
                     'credenc': ['positive', 'trust'], 'credenti': ['positive', 'trust'],
                     'credibl': ['positive', 'trust'], 'cremat': ['sadness'],
                     'crimin': ['anger', 'disgust', 'fear', 'negative'],
                     'cring': ['disgust', 'fear', 'negative', 'sadness'], 'crippl': ['fear', 'negative', 'sadness'],
                     'crisi': ['negative'], 'critiqu': ['positive'], 'crocodil': ['fear'],
                     'crown': ['anticipation', 'joy', 'positive', 'surprise', 'trust'], 'cruciat': ['negative'],
                     'cruelli': ['anger', 'fear', 'negative'],
                     'cruelti': ['anger', 'disgust', 'fear', 'negative', 'sadness'], 'crumbl': ['negative', 'sadness'],
                     'crusad': ['anger', 'fear', 'negative'],
                     'crush': ['anger', 'disgust', 'fear', 'negative', 'sadness'], 'crusti': ['disgust', 'negative'],
                     'cri': ['negative', 'sadness'], 'cuddl': ['joy', 'positive', 'trust'],
                     'culinari': ['positive', 'trust'], 'culmin': ['positive'], 'culpabl': ['negative'],
                     'cultiv': ['anticipation', 'positive', 'trust'], 'cultur': ['positive'],
                     'cumbersom': ['negative', 'sadness'], 'cun': ['negative', 'positive'],
                     'cup': ['disgust', 'fear', 'negative', 'sadness'], 'curabl': ['positive', 'trust'],
                     'curios': ['anticipation', 'positive', 'surprise'],
                     'curs': ['anger', 'disgust', 'fear', 'negative', 'sadness'], 'cursori': ['negative'],
                     'cuss': ['anger'], 'custodi': ['trust'], 'custom': ['positive'],
                     'cut': ['anger', 'disgust', 'fear', 'negative', 'sadness'], 'cyanid': ['fear', 'negative'],
                     'cyclon': ['fear', 'negative', 'surprise'], 'dabbl': ['anger', 'disgust', 'negative'],
                     'daili': ['anticipation'], 'damag': ['anger', 'disgust', 'negative', 'sadness'],
                     'damnat': ['anger', 'fear', 'negative', 'sadness'], 'danc': ['joy', 'positive', 'trust'],
                     'dandi': ['disgust', 'negative'], 'darl': ['joy', 'positive', 'trust'],
                     'dash': ['anger', 'fear', 'negative', 'sadness'],
                     'dastard': ['anger', 'disgust', 'fear', 'negative'], 'daze': ['negative'], 'deactiv': ['negative'],
                     'dead': ['anger', 'disgust', 'fear', 'negative', 'sadness'],
                     'debacl': ['fear', 'negative', 'sadness'], 'debat': ['positive'],
                     'debaucheri': ['disgust', 'fear', 'negative'], 'debentur': ['anticipation'],
                     'debri': ['disgust', 'negative'], 'deceas': ['negative', 'sadness'],
                     'deceiv': ['anger', 'disgust', 'negative', 'sadness'], 'decenc': ['positive'],
                     'decept': ['negative'], 'declaratori': ['positive'], 'declin': ['negative'],
                     'decompos': ['disgust'], 'decomposit': ['disgust', 'fear', 'negative', 'sadness'],
                     'decreas': ['negative'], 'decri': ['anger', 'negative'], 'dedic': ['positive'],
                     'defam': ['disgust', 'fear', 'negative'], 'defamatori': ['anger', 'negative'],
                     'defens': ['anger', 'anticipation', 'fear', 'positive'], 'defer': ['positive', 'trust'],
                     'deferr': ['negative'], 'defianc': ['anger', 'disgust', 'fear', 'negative'],
                     'defici': ['negative'], 'definit': ['positive', 'trust'],
                     'deflat': ['anger', 'negative', 'sadness'],
                     'defi': ['anger', 'fear', 'negative', 'sadness', 'surprise'],
                     'degeneraci': ['anger', 'disgust', 'negative', 'sadness'], 'degener': ['negative'],
                     'degrad': ['negative'], 'degre': ['positive'], 'delect': ['positive'],
                     'deleg': ['positive', 'trust'], 'deleteri': ['anger', 'disgust', 'fear', 'negative'],
                     'delet': ['negative'], 'deliber': ['positive'], 'delici': ['joy', 'positive'],
                     'delinqu': ['negative'], 'deliri': ['negative', 'sadness'],
                     'deliver': ['anticipation', 'joy', 'positive', 'trust'], 'deliveri': ['anticipation', 'positive'],
                     'delug': ['fear', 'negative', 'sadness', 'surprise'],
                     'delus': ['anger', 'fear', 'negative', 'sadness'], 'dement': ['fear', 'negative'],
                     'demis': ['fear', 'negative', 'sadness'], 'democraci': ['positive'], 'demolit': ['negative'],
                     'demonstr': ['positive'], 'demor': ['fear', 'negative', 'sadness'],
                     'deni': ['negative', 'sadness'], 'denounc': ['anger', 'disgust', 'negative'],
                     'dentistri': ['fear'], 'denunci': ['anger', 'disgust', 'fear', 'negative'],
                     'departur': ['negative', 'sadness'], 'deplor': ['anger', 'disgust', 'fear', 'negative', 'sadness'],
                     'depositori': ['trust'],
                     'deprav': ['anger', 'anticipation', 'disgust', 'fear', 'negative', 'sadness'],
                     'depreci': ['anger', 'disgust', 'negative'],
                     'depriv': ['anger', 'disgust', 'fear', 'negative', 'sadness'], 'deputi': ['trust'],
                     'derang': ['anger', 'disgust', 'fear', 'negative'], 'deris': ['anger', 'disgust', 'negative'],
                     'derog': ['anger', 'disgust', 'fear', 'negative', 'sadness'],
                     'derogatori': ['anger', 'disgust', 'fear', 'negative', 'sadness'], 'descript': ['positive'],
                     'desecr': ['anger', 'disgust', 'fear', 'negative', 'sadness'],
                     'deserv': ['anger', 'anticipation', 'positive', 'trust'], 'design': ['trust'],
                     'desir': ['positive'], 'desol': ['fear', 'negative', 'sadness'], 'desper': ['negative'],
                     'despic': ['anger', 'disgust', 'negative'], 'despis': ['anger', 'disgust', 'negative'],
                     'despot': ['fear', 'negative'],
                     'destin': ['anticipation', 'fear', 'joy', 'positive', 'sadness', 'surprise'],
                     'destitut': ['fear', 'negative', 'sadness'], 'destroy': ['anger', 'fear', 'negative', 'sadness'],
                     'destruct': ['anger', 'negative'], 'detach': ['negative'],
                     'detaine': ['anger', 'anticipation', 'fear', 'negative', 'sadness'],
                     'detent': ['negative', 'sadness'], 'deterior': ['fear', 'negative', 'sadness'],
                     'determin': ['anticipation', 'trust'], 'deton': ['fear', 'negative', 'surprise'],
                     'devast': ['anger', 'fear', 'negative', 'sadness'], 'deviat': ['sadness'], 'devolut': ['negative'],
                     'devot': ['positive', 'trust'], 'dexter': ['positive'],
                     'diabol': ['anger', 'disgust', 'fear', 'negative'],
                     'diagnosi': ['anticipation', 'fear', 'negative', 'trust'], 'diari': ['joy', 'positive', 'trust'],
                     'diatrib': ['anger', 'disgust', 'negative'], 'dictat': ['fear', 'negative'],
                     'dictatori': ['anger', 'negative'], 'dictionari': ['positive', 'trust'], 'didact': ['positive'],
                     'dietari': ['anticipation', 'positive'], 'differenti': ['trust'], 'differ': ['surprise'],
                     'difficulti': ['negative', 'sadness'], 'dignifi': ['positive'], 'digniti': ['positive', 'trust'],
                     'dilapid': ['disgust', 'negative', 'sadness'], 'dilig': ['positive', 'trust'],
                     'dilut': ['negative'], 'diplomaci': ['anticipation', 'positive', 'trust'],
                     'diplomat': ['positive', 'trust'], 'dirti': ['disgust', 'negative'],
                     'disabl': ['negative', 'sadness'], 'disaffect': ['negative'], 'disagre': ['anger', 'negative'],
                     'disagr': ['anger', 'negative', 'sadness'],
                     'disallow': ['anger', 'disgust', 'fear', 'negative', 'sadness'],
                     'disapprov': ['negative', 'sadness'],
                     'disast': ['anger', 'disgust', 'fear', 'negative', 'sadness', 'surprise'],
                     'disastr': ['anger', 'fear', 'negative', 'sadness'], 'disbeliev': ['negative'],
                     'discard': ['negative'], 'discharg': ['negative'], 'discipl': ['trust'],
                     'disciplin': ['fear', 'negative'], 'disclos': ['trust'], 'discolor': ['disgust', 'negative'],
                     'discont': ['anger', 'disgust', 'fear', 'negative', 'sadness'], 'discontinu': ['negative'],
                     'discourag': ['fear', 'negative', 'sadness'], 'discoveri': ['positive'],
                     'discret': ['anticipation', 'positive', 'trust'], 'discretionari': ['positive'],
                     'discrimin': ['anger', 'negative', 'sadness'], 'discuss': ['positive'],
                     'diseas': ['anger', 'disgust', 'fear', 'negative', 'sadness'],
                     'disembodi': ['fear', 'negative', 'sadness'], 'disengag': ['negative'],
                     'disfigur': ['anger', 'disgust', 'fear', 'negative', 'sadness'],
                     'disgrac': ['anger', 'disgust', 'negative', 'sadness'],
                     'disgruntl': ['anger', 'disgust', 'negative', 'sadness'], 'dishearten': ['negative', 'sadness'],
                     'dishonesti': ['disgust', 'negative'], 'disillusion': ['anger', 'disgust', 'negative', 'sadness'],
                     'disinfect': ['positive'], 'disinform': ['anger', 'fear', 'negative'],
                     'disingenu': ['disgust', 'negative'], 'disintegr': ['disgust', 'fear', 'negative'],
                     'disinterest': ['negative'], 'dislik': ['anger', 'disgust', 'negative'],
                     'disloc': ['anger', 'disgust', 'fear', 'negative', 'sadness'],
                     'dismember': ['disgust', 'fear', 'negative', 'sadness'],
                     'dismiss': ['anger', 'disgust', 'fear', 'negative', 'sadness', 'surprise'],
                     'disobedi': ['anger', 'disgust', 'negative'], 'disord': ['fear', 'negative'],
                     'disorgan': ['negative'], 'disparag': ['anger', 'disgust', 'negative', 'sadness'],
                     'dispar': ['anger', 'disgust', 'negative', 'sadness'], 'dispassion': ['negative', 'sadness'],
                     'dispers': ['negative'], 'displac': ['negative'],
                     'displeas': ['anger', 'disgust', 'fear', 'negative', 'sadness'],
                     'displeasur': ['disgust', 'negative'], 'dispos': ['negative'],
                     'dispossess': ['anger', 'fear', 'negative', 'sadness'], 'disput': ['anger', 'negative'],
                     'disqualif': ['negative'], 'disqualifi': ['anger', 'disgust', 'negative', 'sadness'],
                     'disreput': ['anger', 'disgust', 'fear', 'negative'],
                     'disrupt': ['anger', 'fear', 'negative', 'surprise'], 'dissatisfact': ['negative'],
                     'dissect': ['disgust'], 'dissemin': ['positive'], 'dissens': ['anger', 'negative'],
                     'dissent': ['negative'], 'disservic': ['anger', 'disgust', 'negative', 'sadness'],
                     'dissid': ['anger', 'fear', 'negative'],
                     'dissolut': ['anger', 'fear', 'negative', 'sadness', 'surprise'], 'disson': ['anger', 'negative'],
                     'distast': ['disgust', 'negative'], 'distil': ['positive'], 'distinct': ['positive'],
                     'distort': ['disgust', 'negative'],
                     'disturb': ['anger', 'fear', 'negative', 'sadness', 'surprise'], 'disus': ['negative'],
                     'ditti': ['joy', 'positive'], 'diverg': ['negative', 'surprise'],
                     'divers': ['negative', 'positive'], 'diversifi': ['positive'], 'divest': ['negative'],
                     'divin': ['anticipation'],
                     'divorc': ['anger', 'disgust', 'fear', 'negative', 'sadness', 'surprise', 'trust'],
                     'dizzi': ['negative'], 'dock': ['negative'], 'doctrin': ['trust'], 'dog': ['positive'],
                     'doldrum': ['negative', 'sadness'], 'domin': ['fear', 'negative'], 'donat': ['positive'],
                     'doodl': ['negative'], 'douch': ['negative'], 'downfal': ['fear', 'negative', 'sadness'],
                     'downi': ['positive'], 'drainag': ['negative'], 'dreari': ['negative', 'sadness'],
                     'drink': ['negative'], 'droop': ['negative'], 'drowsi': ['negative'], 'drudgeri': ['negative'],
                     'drug': ['sadness'], 'dummi': ['negative'], 'dump': ['anger', 'negative', 'sadness'],
                     'duplic': ['anger', 'negative'], 'durabl': ['positive', 'trust'],
                     'duti': ['anticipation', 'positive', 'trust'], 'dwarf': ['fear', 'negative', 'sadness'],
                     'dynam': ['surprise'], 'dysenteri': ['disgust', 'negative', 'sadness'], 'eagl': ['trust'],
                     'earthquak': ['anger', 'fear', 'negative', 'sadness', 'surprise'], 'eas': ['positive'],
                     'easygo': ['positive'], 'eavesdrop': ['negative'], 'economi': ['trust'],
                     'ecstasi': ['anticipation', 'joy', 'positive'],
                     'ecstat': ['anticipation', 'joy', 'positive', 'surprise'],
                     'edif': ['anticipation', 'joy', 'positive', 'trust'], 'edit': ['anticipation'],
                     'educ': ['positive'], 'effect': ['positive', 'trust'], 'effemin': ['negative'],
                     'efficaci': ['positive'], 'effici': ['positive'], 'effigi': ['anger'],
                     'egotist': ['disgust', 'negative'], 'egregi': ['anger', 'disgust', 'negative'],
                     'ejacul': ['anticipation', 'joy', 'positive', 'surprise', 'trust'], 'elabor': ['positive'],
                     'elat': ['joy', 'positive'], 'elector': ['trust'], 'electr': ['joy', 'positive', 'surprise'],
                     'eleg': ['anticipation', 'joy', 'positive', 'trust'],
                     'elev': ['anticipation', 'fear', 'joy', 'positive', 'trust'], 'elig': ['positive'],
                     'elimin': ['anger', 'disgust', 'fear', 'negative', 'sadness'],
                     'elit': ['anticipation', 'joy', 'positive', 'trust'], 'eloqu': ['positive'],
                     'elucid': ['positive', 'trust'], 'elus': ['negative', 'surprise'],
                     'emaci': ['fear', 'negative', 'sadness'], 'emancip': ['anticipation', 'joy', 'positive'],
                     'embezzl': ['negative'], 'embol': ['fear', 'negative', 'sadness'],
                     'embrac': ['anticipation', 'joy', 'positive', 'surprise', 'trust'], 'embroil': ['negative'],
                     'emerg': ['fear', 'negative', 'sadness', 'surprise'], 'emin': ['positive', 'trust'],
                     'empathi': ['positive'], 'emphas': ['trust'], 'empow': ['positive'], 'empti': ['sadness'],
                     'emul': ['positive'], 'enabl': ['positive', 'trust'], 'enclav': ['negative'],
                     'encor': ['positive'], 'encourag': ['joy', 'positive', 'trust'], 'encroach': ['fear', 'negative'],
                     'encumbr': ['anger', 'fear', 'negative', 'sadness'],
                     'endang': ['anticipation', 'fear', 'negative'],
                     'endem': ['disgust', 'fear', 'negative', 'sadness'], 'endocard': ['fear', 'sadness'],
                     'endur': ['positive'], 'enemi': ['anger', 'disgust', 'fear', 'negative'], 'energet': ['positive'],
                     'enforc': ['anger', 'fear', 'negative', 'positive'],
                     'engag': ['anticipation', 'joy', 'positive', 'trust'], 'enhanc': ['positive'],
                     'enigmat': ['fear', 'negative'], 'enmiti': ['anger', 'fear', 'negative', 'sadness'],
                     'enrol': ['anticipation', 'trust'], 'ensembl': ['positive', 'trust'], 'enslav': ['negative'],
                     'entangl': ['anger', 'disgust', 'fear', 'negative', 'sadness'], 'enterpris': ['positive'],
                     'entrail': ['disgust', 'negative'], 'ephemeri': ['positive'],
                     'epidem': ['anger', 'anticipation', 'disgust', 'fear', 'negative', 'sadness', 'surprise'],
                     'epilepsi': ['negative'], 'episcop': ['trust'], 'epitom': ['positive'],
                     'equal': ['joy', 'positive', 'trust'], 'equiti': ['positive'], 'erad': ['anger', 'negative'],
                     'eras': ['fear', 'negative'], 'eros': ['negative'],
                     'erot': ['anticipation', 'joy', 'negative', 'positive', 'surprise', 'trust'],
                     'errat': ['negative', 'surprise'], 'erron': ['negative'], 'erudit': ['positive'],
                     'escal': ['anger', 'negative'], 'escap': ['anticipation', 'fear', 'negative', 'positive'],
                     'espionag': ['negative'], 'essenti': ['positive'], 'esthet': ['positive'], 'estrang': ['negative'],
                     'ether': ['fear'], 'ethic': ['positive'], 'evacu': ['fear', 'negative'],
                     'evad': ['anger', 'disgust', 'fear', 'negative'], 'evanesc': ['sadness', 'surprise'],
                     'evas': ['fear', 'negative', 'sadness'], 'eventu': ['anticipation'], 'everlast': ['positive'],
                     'evid': ['positive', 'trust'], 'evolut': ['positive'], 'exacerb': ['negative'],
                     'exact': ['negative'], 'exagger': ['anger', 'negative'],
                     'examin': ['fear', 'negative', 'surprise'], 'exasper': ['anger', 'disgust', 'negative'],
                     'excav': ['anticipation', 'negative', 'surprise'], 'exchang': ['positive', 'trust'],
                     'excis': ['negative'], 'excit': ['positive'], 'exclud': ['disgust', 'negative', 'sadness'],
                     'exclus': ['disgust', 'fear', 'negative', 'sadness'], 'excret': ['disgust'],
                     'excruci': ['fear', 'negative'], 'excus': ['negative'],
                     'execut': ['anger', 'fear', 'negative', 'sadness', 'trust'], 'exemplari': ['positive'],
                     'exempt': ['positive'], 'exhilar': ['joy', 'positive', 'surprise'],
                     'exig': ['anticipation', 'disgust', 'fear', 'negative', 'surprise'],
                     'exil': ['anger', 'fear', 'negative', 'sadness'], 'exist': ['positive'],
                     'exorc': ['fear', 'negative', 'sadness'], 'exot': ['positive'], 'expatri': ['negative'],
                     'expedi': ['joy', 'positive', 'trust'], 'expedit': ['anticipation', 'positive'],
                     'expenditur': ['negative'], 'expens': ['negative'], 'experienc': ['positive', 'trust'],
                     'experi': ['anticipation', 'surprise'], 'expertis': ['positive', 'trust'],
                     'expir': ['negative', 'sadness'], 'explet': ['anger', 'negative'],
                     'explod': ['anger', 'fear', 'negative', 'sadness', 'surprise'], 'explor': ['anticipation'],
                     'explos': ['fear', 'negative', 'surprise'], 'expos': ['anticipation', 'fear'],
                     'expropri': ['negative'], 'expuls': ['anger', 'disgust', 'fear', 'negative', 'sadness'],
                     'exquisit': ['joy', 'positive'], 'extens': ['positive'],
                     'extermin': ['fear', 'negative', 'sadness'], 'extrajudici': ['fear', 'negative'],
                     'extraordinari': ['positive'], 'extrem': ['negative'], 'extric': ['anticipation', 'positive'],
                     'exuber': ['joy', 'positive'], 'eyewit': ['trust'], 'fabric': ['negative'],
                     'facilit': ['positive'], 'faculti': ['positive', 'trust'], 'faec': ['disgust', 'negative'],
                     'fail': ['anger', 'anticipation', 'fear', 'negative', 'sadness'],
                     'failur': ['disgust', 'fear', 'negative', 'sadness'],
                     'faint': ['fear', 'negative', 'sadness', 'surprise'], 'fallaci': ['anger', 'negative'],
                     'fallibl': ['negative'], 'fals': ['negative'], 'falsif': ['anger', 'negative'],
                     'falsifi': ['disgust', 'negative'], 'falsiti': ['disgust', 'negative'],
                     'famin': ['negative', 'sadness'], 'fanat': ['negative'],
                     'fanci': ['anticipation', 'joy', 'positive'],
                     'fanfar': ['anticipation', 'joy', 'positive', 'surprise'], 'farc': ['negative'],
                     'farcic': ['disgust', 'negative'], 'fascin': ['positive'], 'fashion': ['positive'],
                     'fast': ['negative', 'sadness'], 'fatigu': ['negative'],
                     'fatti': ['disgust', 'negative', 'sadness'], 'faulti': ['negative'],
                     'favor': ['anticipation', 'joy', 'positive', 'surprise', 'trust'],
                     'favorit': ['joy', 'positive', 'trust'], 'featur': ['positive'], 'febril': ['negative'],
                     'fece': ['disgust', 'negative'], 'feebl': ['negative', 'sadness'],
                     'feel': ['anger', 'anticipation', 'disgust', 'fear', 'joy', 'negative', 'positive', 'sadness',
                              'surprise', 'trust'], 'feign': ['negative'], 'felic': ['joy', 'positive'],
                     'feloni': ['negative'], 'femal': ['positive'], 'fenc': ['anger'],
                     'feroci': ['anger', 'disgust', 'fear', 'negative'], 'feroc': ['anger', 'negative'],
                     'fertil': ['positive'], 'festiv': ['anticipation', 'joy', 'positive', 'surprise'],
                     'fickl': ['negative'], 'fictiti': ['negative'], 'fidel': ['joy', 'positive', 'trust'],
                     'fierc': ['anger', 'disgust', 'fear', 'negative'], 'filibust': ['negative'],
                     'filthi': ['disgust', 'negative'],
                     'final': ['anticipation', 'disgust', 'joy', 'positive', 'surprise', 'trust'],
                     'fineri': ['positive'], 'finess': ['positive'], 'firearm': ['anger', 'fear', 'negative'],
                     'firebal': ['positive'], 'firm': ['positive', 'trust'], 'fit': ['anger', 'negative'],
                     'fix': ['trust'], 'fixtur': ['positive'], 'flabbi': ['disgust', 'negative'], 'flag': ['negative'],
                     'flang': ['trust'], 'flatter': ['joy', 'positive'], 'flatul': ['disgust', 'negative'],
                     'fleec': ['anger', 'disgust', 'negative', 'sadness'], 'fleshi': ['negative'],
                     'flexibl': ['positive'], 'floweri': ['positive'], 'fluctuat': ['anger', 'fear', 'negative'],
                     'fli': ['fear', 'positive'], 'foil': ['negative'], 'follow': ['trust'], 'folli': ['negative'],
                     'fond': ['joy', 'positive'], 'footbal': ['anticipation', 'joy', 'positive'], 'foot': ['trust'],
                     'forag': ['negative'], 'forbear': ['positive'], 'forc': ['anger', 'fear', 'negative'],
                     'forcibl': ['anger', 'fear', 'negative'], 'forebod': ['anticipation', 'fear', 'negative'],
                     'foreclos': ['fear', 'negative', 'sadness'], 'forefath': ['joy', 'positive', 'trust'],
                     'forerunn': ['positive'], 'forese': ['anticipation', 'positive', 'surprise', 'trust'],
                     'forewarn': ['anticipation', 'fear', 'negative'], 'forfeitur': ['fear', 'negative', 'sadness'],
                     'forg': ['positive'], 'forgeri': ['negative'], 'forgiv': ['positive'], 'formal': ['trust'],
                     'format': ['positive', 'trust'], 'formid': ['fear'], 'form': ['anticipation'],
                     'fornic': ['negative'], 'forsak': ['negative', 'sadness'], 'forthcom': ['positive'],
                     'fortifi': ['positive'], 'fortitud': ['joy', 'positive', 'trust'], 'fortun': ['positive'],
                     'foundat': ['positive'], 'fractur': ['negative'], 'fragil': ['fear', 'negative', 'sadness'],
                     'frailti': ['negative', 'sadness'], 'fratern': ['joy', 'positive', 'trust'],
                     'fraudul': ['anger', 'disgust', 'negative'], 'freeli': ['joy', 'positive', 'trust'],
                     'freez': ['negative'], 'frenet': ['anger', 'fear', 'negative', 'surprise'],
                     'frenzi': ['anger', 'fear', 'negative'], 'friendli': ['joy', 'positive', 'trust'],
                     'frigat': ['fear'], 'friski': ['anticipation', 'joy', 'positive', 'surprise'],
                     'frivol': ['negative'], 'frostbit': ['negative'], 'fruit': ['positive'],
                     'frustrat': ['anger', 'disgust', 'negative', 'sadness'], 'fudg': ['negative'],
                     'fugit': ['anger', 'disgust', 'fear', 'negative', 'sadness', 'trust'],
                     'fulfil': ['joy', 'positive'], 'fulli': ['positive', 'trust'], 'fumbl': ['negative'],
                     'fundament': ['positive', 'trust'], 'funer': ['sadness'], 'furnac': ['anger'],
                     'furi': ['anger', 'fear', 'negative', 'sadness'], 'fussi': ['disgust', 'negative'],
                     'futil': ['negative', 'sadness'], 'gabi': ['disgust', 'negative'], 'gallantri': ['positive'],
                     'gallow': ['anger', 'fear', 'negative', 'sadness'], 'galor': ['positive'], 'gambl': ['negative'],
                     'garbag': ['disgust', 'negative'], 'gauch': ['negative'], 'gaug': ['trust'],
                     'gazett': ['positive', 'trust'],
                     'generos': ['anticipation', 'joy', 'positive', 'surprise', 'trust'], 'gentl': ['positive'],
                     'gentri': ['positive', 'trust'], 'genuin': ['positive', 'trust'],
                     'geriatr': ['negative', 'sadness'], 'germin': ['anticipation'],
                     'ghast': ['disgust', 'fear', 'negative'], 'gigant': ['positive'], 'giggl': ['joy', 'positive'],
                     'give': ['positive'], 'gladiat': ['fear'], 'gloomi': ['negative', 'sadness'],
                     'glorif': ['joy', 'positive'], 'glorifi': ['anticipation', 'joy', 'positive', 'surprise', 'trust'],
                     'glori': ['anticipation', 'joy', 'positive', 'trust'], 'gluttoni': ['disgust', 'negative'],
                     'goodwil': ['positive'], 'gorg': ['disgust', 'negative'],
                     'gori': ['anger', 'disgust', 'fear', 'negative', 'sadness'], 'goug': ['negative'],
                     'gover': ['trust'], 'graduat': ['anticipation', 'fear', 'joy', 'positive', 'surprise', 'trust'],
                     'grandfath': ['trust'], 'grandmoth': ['positive'], 'grasp': ['anticipation', 'negative'],
                     'gratifi': ['joy', 'positive', 'surprise'], 'gratitud': ['joy', 'positive'],
                     'gratuit': ['disgust'], 'gravit': ['anticipation'], 'greasi': ['disgust'],
                     'great': ['joy', 'positive', 'surprise', 'trust'], 'greedi': ['disgust', 'negative'],
                     'greet': ['positive', 'surprise'], 'gregari': ['positive'], 'grenad': ['fear', 'negative'],
                     'grievanc': ['anger', 'disgust', 'negative', 'sadness'], 'griev': ['fear', 'negative', 'sadness'],
                     'grimi': ['disgust', 'negative'], 'grind': ['negative'], 'grisli': ['disgust', 'fear', 'negative'],
                     'grizzli': ['fear', 'negative'], 'grotesqu': ['disgust', 'negative'],
                     'grudg': ['anger', 'negative'], 'gruesom': ['disgust', 'negative'],
                     'grumbl': ['anger', 'disgust', 'negative'], 'grumpi': ['anger', 'disgust', 'negative', 'sadness'],
                     'guarante': ['positive', 'trust'], 'gubernatori': ['positive', 'trust'],
                     'guidanc': ['positive', 'trust'], 'guid': ['positive', 'trust'], 'guil': ['negative'],
                     'guillotin': ['anger', 'anticipation', 'disgust', 'fear', 'negative', 'sadness'],
                     'guilti': ['anger', 'negative', 'sadness'], 'guis': ['negative'],
                     'gullibl': ['negative', 'sadness', 'trust'], 'gunpowd': ['fear'], 'guzzl': ['negative'],
                     'gypsi': ['negative'], 'habitu': ['anticipation'], 'hairi': ['disgust', 'negative'],
                     'hallucin': ['fear', 'negative'], 'halt': ['fear', 'negative', 'sadness'],
                     'hamstr': ['anger', 'negative', 'sadness'], 'handi': ['positive'],
                     'hang': ['anger', 'disgust', 'fear', 'negative', 'sadness'], 'hanker': ['anticipation'],
                     'happili': ['joy', 'positive'], 'happi': ['anticipation', 'joy', 'positive'],
                     'harbing': ['anger', 'anticipation', 'fear', 'negative'],
                     'harden': ['anger', 'disgust', 'fear', 'negative'], 'hard': ['negative'],
                     'hardi': ['joy', 'positive', 'trust'], 'harmoni': ['joy', 'positive', 'trust'],
                     'harrow': ['fear', 'negative'], 'harri': ['anger', 'negative', 'sadness'],
                     'harsh': ['anger', 'fear', 'negative'], 'hast': ['anticipation'], 'hasti': ['negative'],
                     'hatr': ['anger', 'disgust', 'fear', 'negative', 'sadness'], 'haughti': ['anger', 'negative'],
                     'headach': ['negative'], 'headi': ['negative'], 'health': ['joy', 'positive'],
                     'healthi': ['positive'], 'hear': ['fear', 'negative'], 'hears': ['fear', 'negative', 'sadness'],
                     'heartach': ['negative', 'sadness'], 'heartili': ['joy', 'positive'],
                     'heaven': ['anticipation', 'joy', 'positive', 'trust'], 'heavili': ['negative'],
                     'hedon': ['joy', 'negative', 'positive'], 'help': ['joy', 'positive', 'trust'],
                     'hemorrhag': ['disgust', 'fear', 'negative', 'sadness'], 'hemorrhoid': ['negative'],
                     'heresi': ['negative'], 'heret': ['disgust', 'negative'], 'heritag': ['trust'],
                     'hermaphrodit': ['negative', 'surprise'], 'herp': ['disgust', 'negative'],
                     'hesit': ['fear', 'negative'], 'hilari': ['joy', 'positive', 'surprise'],
                     'hilar': ['joy', 'positive'], 'hinder': ['negative', 'sadness'], 'hindranc': ['negative'],
                     'hippi': ['negative'], 'hoars': ['negative'], 'hoari': ['negative', 'sadness'],
                     'hobbi': ['joy', 'positive'],
                     'holi': ['anticipation', 'fear', 'joy', 'positive', 'surprise', 'trust'], 'homag': ['positive'],
                     'homicid': ['anger', 'fear', 'negative'], 'homolog': ['positive'], 'homosexu': ['negative'],
                     'honesti': ['positive', 'trust'], 'hook': ['negative'], 'hord': ['negative', 'surprise'],
                     'horoscop': ['anticipation'], 'horribl': ['anger', 'disgust', 'fear', 'negative'],
                     'horrif': ['anger', 'disgust', 'fear', 'negative', 'sadness'], 'horrifi': ['fear', 'negative'],
                     'hors': ['trust'], 'hospic': ['sadness'], 'hospit': ['fear', 'sadness', 'trust'],
                     'hostag': ['anger', 'fear', 'negative'], 'hostil': ['anger', 'disgust', 'fear', 'negative'],
                     'housekeep': ['positive'], 'human': ['positive'],
                     'humbl': ['disgust', 'negative', 'positive', 'sadness'],
                     'humili': ['anger', 'negative', 'sadness'], 'humil': ['positive', 'trust'],
                     'humor': ['joy', 'positive'], 'hungri': ['anticipation', 'negative'],
                     'hunt': ['anger', 'anticipation', 'fear', 'negative'], 'hurrican': ['fear', 'negative'],
                     'hurri': ['anticipation', 'negative'], 'husbandri': ['positive', 'trust'], 'hygien': ['positive'],
                     'hyperbol': ['negative'], 'hypertrophi': ['disgust', 'fear', 'surprise'],
                     'hypocrisi': ['negative'], 'hypocrit': ['disgust', 'negative'],
                     'hypothesi': ['anticipation', 'surprise'], 'hyster': ['anger', 'fear', 'negative'],
                     'ideal': ['positive'], 'idioci': ['anger', 'disgust', 'negative', 'sadness'],
                     'idolatri': ['disgust', 'fear', 'negative'], 'ignor': ['negative'],
                     'illeg': ['anger', 'disgust', 'fear', 'negative', 'sadness'],
                     'illegitim': ['anger', 'disgust', 'fear', 'negative', 'sadness', 'surprise'],
                     'illiter': ['disgust', 'negative'], 'illog': ['negative'],
                     'illumin': ['anticipation', 'joy', 'positive', 'surprise'], 'illus': ['negative', 'surprise'],
                     'illustr': ['positive'], 'illustri': ['positive'], 'imagin': ['positive'], 'imit': ['negative'],
                     'immacul': ['joy', 'positive', 'trust'], 'immatur': ['anticipation', 'negative'],
                     'immediaci': ['surprise'], 'immedi': ['anticipation', 'negative', 'positive'],
                     'immens': ['positive'], 'immers': ['anticipation', 'fear', 'joy', 'positive', 'surprise', 'trust'],
                     'immigr': ['fear'], 'immin': ['anticipation', 'fear'],
                     'immor': ['anger', 'disgust', 'fear', 'negative', 'sadness'], 'immort': ['positive'],
                     'immov': ['negative', 'positive', 'trust'], 'immun': ['trust'], 'imparti': ['positive', 'trust'],
                     'impass': ['negative'], 'impati': ['negative'], 'impecc': ['positive', 'trust'],
                     'imped': ['negative'], 'impend': ['anticipation', 'fear'], 'impenetr': ['trust'],
                     'imperfect': ['negative'], 'imperm': ['anger', 'fear'], 'imperson': ['negative'],
                     'impervi': ['positive'], 'implac': ['negative'], 'implic': ['anger', 'negative'],
                     'impolit': ['disgust', 'negative'], 'import': ['anticipation', 'positive'],
                     'imposit': ['negative'], 'imposs': ['negative', 'sadness'],
                     'impot': ['anger', 'fear', 'negative', 'sadness'], 'impractic': ['negative'],
                     'improprieti': ['negative'], 'improv': ['anticipation', 'joy', 'positive', 'trust'],
                     'improvis': ['surprise'], 'imprud': ['negative', 'sadness'], 'impur': ['disgust', 'negative'],
                     'imput': ['negative'], 'inabl': ['negative', 'sadness'], 'inaccess': ['negative'],
                     'inaccur': ['negative'], 'inact': ['negative'], 'inadequaci': ['negative'],
                     'inadequ': ['negative', 'sadness'], 'inadmiss': ['anger', 'disgust', 'negative'],
                     'inalien': ['positive'], 'inan': ['negative'], 'inapplic': ['negative'],
                     'inappropri': ['anger', 'disgust', 'negative', 'sadness'], 'inattent': ['anger', 'negative'],
                     'inaud': ['negative'], 'inaugur': ['anticipation'], 'incalcul': ['negative'],
                     'incapac': ['negative'], 'incarcer': ['anger', 'disgust', 'fear', 'negative', 'sadness'],
                     'incas': ['anger', 'disgust', 'fear', 'negative', 'sadness'],
                     'incendiari': ['anger', 'fear', 'negative', 'surprise'], 'incens': ['anger', 'negative'],
                     'incess': ['negative'], 'incestu': ['disgust', 'negative'], 'incid': ['surprise'],
                     'inciner': ['negative'], 'incis': ['positive'],
                     'incit': ['anger', 'anticipation', 'fear', 'negative'], 'inclin': ['trust'],
                     'includ': ['positive'], 'inclus': ['trust'], 'incoher': ['negative'],
                     'incom': ['anticipation', 'joy', 'negative', 'positive', 'sadness', 'trust'],
                     'incompat': ['anger', 'disgust', 'negative', 'sadness'], 'incompet': ['negative'],
                     'incomplet': ['negative'], 'incomprehens': ['negative'], 'incongru': ['anger', 'negative'],
                     'inconsequenti': ['negative', 'sadness'],
                     'inconsider': ['anger', 'disgust', 'negative', 'sadness'], 'inconsist': ['negative'],
                     'incontin': ['surprise'], 'inconveni': ['anger', 'disgust', 'negative', 'sadness'],
                     'increas': ['positive'], 'incredul': ['anger', 'disgust', 'negative'],
                     'incrimin': ['fear', 'negative', 'sadness'], 'incurs': ['fear', 'negative'],
                     'indec': ['anger', 'disgust'], 'indecis': ['negative'], 'indefens': ['fear', 'negative'],
                     'indel': ['positive', 'trust'], 'indemnifi': ['negative'], 'indemn': ['positive', 'trust'],
                     'indentur': ['anger', 'negative'],
                     'independ': ['anticipation', 'joy', 'positive', 'surprise', 'trust'],
                     'indestruct': ['positive', 'trust'], 'indetermin': ['negative'],
                     'indiffer': ['anger', 'disgust', 'fear', 'negative', 'sadness'], 'indig': ['negative', 'sadness'],
                     'indign': ['anger', 'negative'], 'individu': ['positive'], 'indivis': ['trust'],
                     'indoctrin': ['anger', 'fear', 'negative'], 'indol': ['negative'], 'indomit': ['fear', 'positive'],
                     'ineff': ['positive'], 'ineffect': ['negative'], 'ineffectu': ['disgust', 'negative'],
                     'ineffici': ['disgust', 'negative', 'sadness'],
                     'ineptitud': ['disgust', 'fear', 'negative', 'sadness'],
                     'inequ': ['anger', 'fear', 'negative', 'sadness'], 'inequit': ['negative'],
                     'inexcus': ['anger', 'disgust', 'negative', 'sadness'], 'inexpens': ['positive'],
                     'inexperi': ['negative'], 'inexperienc': ['negative'], 'inexplic': ['negative', 'surprise'],
                     'infal': ['trust'], 'infam': ['anger', 'disgust', 'fear', 'negative'],
                     'infami': ['negative', 'sadness'],
                     'infanticid': ['anger', 'anticipation', 'disgust', 'fear', 'negative', 'sadness'],
                     'infantil': ['anger', 'disgust', 'negative'],
                     'infecti': ['disgust', 'fear', 'negative', 'sadness'], 'infertil': ['negative', 'sadness'],
                     'infest': ['disgust', 'fear', 'negative'], 'infiltr': ['negative', 'positive'],
                     'infinit': ['positive'], 'infin': ['anticipation', 'joy', 'positive', 'trust'],
                     'inflamm': ['negative'], 'inflat': ['negative'], 'influenc': ['negative', 'positive'],
                     'influenti': ['positive', 'trust'], 'infract': ['anger', 'negative'], 'infrequ': ['surprise'],
                     'infring': ['negative'], 'ingeni': ['positive'],
                     'inherit': ['anticipation', 'joy', 'positive', 'surprise', 'trust'],
                     'inhospit': ['negative', 'sadness'], 'inim': ['anger', 'negative', 'sadness'],
                     'inimit': ['positive', 'trust'], 'iniqu': ['disgust', 'negative'], 'inject': ['fear'],
                     'injunct': ['negative'], 'injur': ['anger', 'fear', 'negative', 'sadness'],
                     'injuri': ['anger', 'fear', 'negative', 'sadness'], 'injustic': ['anger', 'negative'],
                     'inmat': ['disgust', 'fear', 'negative'], 'innoc': ['positive'], 'innocu': ['positive'],
                     'innov': ['positive'], 'inocul': ['anticipation', 'trust'], 'inop': ['anger', 'negative'],
                     'inquir': ['positive'], 'inquiri': ['anticipation', 'positive'], 'inquisit': ['positive'],
                     'insan': ['anger', 'fear', 'negative'], 'insecur': ['anger', 'fear', 'negative', 'sadness'],
                     'insepar': ['joy', 'positive', 'trust'], 'insidi': ['anger', 'disgust', 'fear', 'negative'],
                     'insignific': ['negative'], 'insol': ['negative'],
                     'insolv': ['fear', 'negative', 'sadness', 'surprise'],
                     'inspir': ['anticipation', 'joy', 'positive'], 'instabl': ['disgust', 'fear', 'negative'],
                     'instal': ['anticipation'], 'instig': ['negative'],
                     'instinct': ['anger', 'disgust', 'fear', 'positive'], 'institut': ['trust'],
                     'instrument': ['positive'], 'insuffici': ['anger', 'negative'], 'insul': ['trust'],
                     'insur': ['positive', 'trust'], 'insurg': ['negative'],
                     'insurmount': ['fear', 'negative', 'sadness'], 'insurrect': ['anger', 'negative'],
                     'integr': ['positive', 'trust'], 'intellectu': ['positive'],
                     'intellig': ['fear', 'joy', 'positive', 'trust'],
                     'intens': ['anger', 'disgust', 'fear', 'joy', 'negative', 'positive', 'surprise', 'trust'],
                     'interced': ['fear', 'sadness'], 'intercess': ['trust'], 'intercours': ['positive'],
                     'interdict': ['negative'], 'interfer': ['negative'], 'interlocutori': ['positive'],
                     'interlud': ['positive'], 'intermin': ['anger', 'anticipation', 'negative', 'positive'],
                     'intermiss': ['anticipation'], 'interrog': ['fear'],
                     'intervent': ['negative', 'positive', 'sadness'], 'interview': ['fear'], 'intest': ['negative'],
                     'intestin': ['disgust'], 'intim': ['anticipation', 'joy', 'positive', 'trust'],
                     'intimid': ['fear', 'negative'], 'intoler': ['anger', 'negative'], 'inton': ['positive'],
                     'intox': ['disgust', 'negative'], 'intract': ['anger', 'negative'],
                     'intrigu': ['anticipation', 'fear', 'negative', 'surprise'],
                     'intrud': ['anger', 'fear', 'negative', 'surprise'], 'intrus': ['fear', 'negative'],
                     'intuit': ['positive', 'trust'], 'invad': ['anger', 'fear', 'negative', 'sadness', 'surprise'],
                     'invari': ['positive'], 'invas': ['anger', 'negative'], 'invent': ['positive'],
                     'investig': ['positive'], 'invigor': ['positive'], 'invit': ['anticipation', 'positive'],
                     'invoc': ['anticipation', 'trust'], 'invok': ['anticipation'], 'involuntari': ['negative'],
                     'involut': ['anger', 'negative'], 'involv': ['anger'], 'irat': ['anger', 'negative'],
                     'iri': ['fear'], 'irrat': ['disgust', 'fear', 'negative'], 'irrate': ['negative'],
                     'irreconcil': ['anger', 'fear', 'negative', 'sadness'], 'irreduc': ['positive'],
                     'irrefut': ['positive', 'trust'], 'irrelev': ['negative'],
                     'irrepar': ['fear', 'negative', 'sadness'], 'irrespons': ['negative'], 'irrever': ['negative'],
                     'irrevoc': ['negative'], 'irrit': ['anger', 'negative'], 'isol': ['sadness'],
                     'jar': ['fear', 'negative', 'sadness'], 'jaundic': ['fear', 'negative'], 'jaw': ['fear'],
                     'jealousi': ['anger', 'disgust', 'fear', 'negative', 'sadness'],
                     'jeopard': ['anger', 'fear', 'negative'], 'jeopardi': ['anticipation', 'fear', 'negative'],
                     'journal': ['trust'], 'jubil': ['joy', 'positive', 'surprise', 'trust'],
                     'jubile': ['joy', 'positive', 'surprise'], 'judici': ['anticipation', 'positive', 'trust'],
                     'judiciari': ['anticipation', 'trust'], 'jumbl': ['negative'], 'jungl': ['fear'],
                     'jurisprud': ['sadness'], 'juri': ['trust'], 'justic': ['positive', 'trust'],
                     'justifi': ['positive', 'trust'], 'justif': ['positive'], 'juvenil': ['negative'],
                     'keepsak': ['positive'], 'kerosen': ['fear'], 'keynot': ['positive'], 'keyston': ['positive'],
                     'kindr': ['anticipation', 'joy', 'positive', 'trust'], 'knicker': ['trust'], 'knot': ['negative'],
                     'know': ['positive'], 'knowledg': ['positive'], 'kudo': ['joy', 'positive'],
                     'labori': ['negative'], 'lacklust': ['negative'], 'landslid': ['fear', 'negative', 'sadness'],
                     'laps': ['negative'], 'larceni': ['disgust', 'negative'], 'latrin': ['disgust', 'negative'],
                     'laudabl': ['positive'], 'laughabl': ['disgust', 'negative'], 'laureat': ['positive', 'trust'],
                     'lavatori': ['disgust'], 'lawless': ['anger', 'fear', 'negative'],
                     'laxat': ['disgust', 'fear', 'negative'], 'lazi': ['negative'], 'leagu': ['positive'],
                     'leakag': ['negative'], 'leaki': ['negative'], 'lean': ['trust'],
                     'leav': ['negative', 'sadness', 'surprise'], 'lectur': ['positive'], 'leeri': ['surprise'],
                     'legendari': ['positive'], 'legibl': ['positive'], 'legisl': ['trust'], 'legislatur': ['trust'],
                     'legitimaci': ['trust'], 'leisur': ['anticipation', 'joy', 'positive', 'surprise', 'trust'],
                     'leprosi': ['disgust', 'fear', 'negative', 'sadness'], 'lethargi': ['negative', 'sadness'],
                     'leve': ['trust'], 'leverag': ['positive'], 'levi': ['negative'],
                     'liber': ['negative', 'positive'],
                     'liberti': ['anticipation', 'joy', 'positive', 'surprise', 'trust'], 'librari': ['positive'],
                     'lieuten': ['trust'], 'lighthous': ['positive'], 'lightn': ['anger', 'fear', 'surprise'],
                     'like': ['joy', 'positive', 'trust'], 'limit': ['anger', 'negative', 'sadness'], 'line': ['fear'],
                     'lith': ['positive'], 'litig': ['negative'], 'litigi': ['anger', 'disgust', 'negative'],
                     'loathsom': ['anger', 'disgust', 'negative'], 'local': ['anticipation'], 'lodg': ['trust'],
                     'lofti': ['negative'], 'logic': ['positive'], 'loneli': ['fear', 'negative', 'sadness'],
                     'lonesom': ['negative', 'sadness'], 'longev': ['positive'], 'looni': ['negative'],
                     'lotteri': ['anticipation'], 'loud': ['anger', 'negative'], 'loung': ['negative'],
                     'lous': ['disgust', 'negative'], 'lovabl': ['joy', 'positive', 'trust'],
                     'lovemak': ['joy', 'positive', 'trust'], 'lowland': ['negative'], 'lowli': ['negative', 'sadness'],
                     'loyalti': ['positive', 'trust'], 'lucki': ['joy', 'positive', 'surprise'], 'ludicr': ['negative'],
                     'lumber': ['negative'], 'lumpi': ['disgust', 'negative'],
                     'lunaci': ['anger', 'disgust', 'fear', 'negative', 'sadness'],
                     'lunat': ['anger', 'disgust', 'fear', 'negative'], 'lung': ['surprise'], 'lusti': ['disgust'],
                     'luxuri': ['positive'], 'lyric': ['joy', 'positive'], 'machin': ['trust'],
                     'magic': ['anticipation', 'joy', 'positive', 'surprise'], 'magnetit': ['positive'],
                     'magnific': ['anticipation', 'joy', 'positive', 'trust'], 'mainten': ['trust'],
                     'majest': ['anticipation', 'joy', 'positive', 'surprise', 'trust'],
                     'majesti': ['positive', 'trust'], 'maladi': ['negative'], 'malais': ['negative', 'sadness'],
                     'malevol': ['anger', 'disgust', 'fear', 'negative', 'sadness'], 'malfeas': ['disgust', 'negative'],
                     'malform': ['negative'], 'malic': ['anger', 'fear', 'negative'],
                     'malici': ['anger', 'disgust', 'fear', 'negative', 'sadness'], 'malpractic': ['anger', 'negative'],
                     'manag': ['positive', 'trust'], 'mang': ['disgust', 'fear', 'negative'],
                     'mangl': ['anger', 'disgust', 'fear', 'negative', 'sadness'], 'manifest': ['fear'],
                     'manipul': ['negative'], 'man': ['positive'], 'manner': ['positive'],
                     'manslaught': ['anger', 'disgust', 'fear', 'negative', 'sadness', 'surprise'],
                     'manufactur': ['positive'], 'manur': ['disgust', 'negative'], 'marin': ['trust'],
                     'mark': ['positive'], 'market': ['positive'], 'marqui': ['positive'],
                     'marriag': ['anticipation', 'joy', 'positive', 'trust'],
                     'marri': ['anticipation', 'fear', 'joy', 'positive', 'surprise', 'trust'],
                     'martingal': ['negative'], 'masculin': ['positive'],
                     'masoch': ['anger', 'disgust', 'fear', 'negative'],
                     'massacr': ['anger', 'disgust', 'fear', 'negative', 'sadness'], 'massag': ['joy', 'positive'],
                     'masterpiec': ['joy', 'positive'], 'masteri': ['anger', 'joy', 'positive', 'trust'],
                     'matchmak': ['anticipation'], 'materi': ['negative'],
                     'matern': ['anticipation', 'negative', 'positive'], 'mathemat': ['trust'],
                     'matrimoni': ['anticipation', 'joy', 'positive', 'trust'], 'meander': ['negative'],
                     'measl': ['disgust', 'fear', 'negative', 'sadness'], 'measur': ['trust'],
                     'meddl': ['anger', 'negative'], 'mediat': ['anticipation', 'positive', 'trust'],
                     'medic': ['anticipation', 'fear', 'positive', 'trust'], 'mediocr': ['negative'],
                     'medit': ['anticipation', 'joy', 'positive', 'trust'], 'melanchol': ['negative', 'sadness'],
                     'melancholi': ['negative', 'sadness'], 'mele': ['fear', 'negative'],
                     'memor': ['joy', 'positive', 'surprise', 'trust'], 'memori': ['sadness'],
                     'menac': ['anger', 'fear', 'negative'], 'mend': ['positive'], 'mens': ['positive'],
                     'mercenari': ['fear', 'negative'], 'merci': ['positive'], 'merg': ['anticipation', 'positive'],
                     'meritori': ['joy', 'positive', 'trust'], 'merri': ['joy', 'positive'], 'messeng': ['trust'],
                     'messi': ['disgust', 'negative'], 'metastasi': ['negative'], 'mettl': ['positive'],
                     'microscop': ['trust'], 'microscopi': ['positive'],
                     'midwif': ['anticipation', 'joy', 'negative', 'positive', 'trust'], 'midwiferi': ['positive'],
                     'mighti': ['anger', 'fear', 'joy', 'positive', 'trust'], 'militari': ['fear'],
                     'mimicri': ['negative', 'surprise'], 'mind': ['positive'], 'minim': ['negative'],
                     'ministri': ['joy', 'positive', 'trust'], 'minor': ['negative'],
                     'miracl': ['anticipation', 'joy', 'positive', 'surprise', 'trust'],
                     'miracul': ['joy', 'positive', 'surprise'], 'miscarriag': ['fear', 'negative', 'sadness'],
                     'mischiev': ['negative'], 'misconcept': ['anger', 'disgust', 'fear', 'negative'],
                     'miser': ['anger', 'disgust', 'negative', 'sadness'],
                     'miseri': ['anger', 'disgust', 'fear', 'negative', 'sadness'],
                     'misfortun': ['fear', 'negative', 'sadness'], 'misguid': ['disgust', 'negative'],
                     'misinterpret': ['negative'], 'mismanag': ['negative'], 'misnom': ['negative'],
                     'misplac': ['anger', 'disgust', 'negative'], 'misrepres': ['negative'], 'missil': ['fear'],
                     'miss': ['fear', 'negative', 'sadness'], 'missionari': ['positive'],
                     'misstat': ['anger', 'disgust', 'negative'], 'mistak': ['negative', 'sadness'],
                     'misus': ['negative'], 'mobil': ['anticipation'], 'mockeri': ['disgust', 'negative'],
                     'mock': ['anger', 'disgust', 'negative', 'sadness'], 'moder': ['positive'],
                     'modesti': ['positive'], 'modifi': ['surprise'],
                     'molest': ['anger', 'disgust', 'fear', 'negative', 'sadness'],
                     'monetari': ['anticipation', 'positive'], 'monochrom': ['disgust', 'negative'],
                     'monogami': ['trust'], 'monstros': ['anger', 'disgust', 'fear', 'negative', 'surprise'],
                     'moodi': ['anger', 'negative', 'sadness'], 'moor': ['trust'],
                     'morgu': ['disgust', 'fear', 'negative', 'sadness'], 'mortgag': ['fear'],
                     'mortif': ['anticipation', 'disgust', 'fear', 'negative', 'sadness'],
                     'mortuari': ['fear', 'negative', 'sadness'], 'mosqu': ['anger'], 'motiv': ['positive'],
                     'movabl': ['positive'], 'muddl': ['negative'], 'muddi': ['disgust', 'negative'],
                     'mumbl': ['negative'], 'mump': ['negative'], 'murki': ['disgust', 'negative', 'sadness'],
                     'musti': ['disgust', 'negative'], 'mutabl': ['anticipation', 'positive'],
                     'mutil': ['disgust', 'negative'], 'mutini': ['anger', 'disgust', 'fear', 'negative', 'surprise'],
                     'muzzl': ['fear', 'negative'], 'mysteri': ['anticipation', 'fear', 'surprise'],
                     'naiv': ['negative'], 'nappi': ['disgust', 'negative'], 'narcot': ['negative'],
                     'nasti': ['anger', 'disgust', 'fear', 'negative', 'sadness'], 'naughti': ['negative'],
                     'navig': ['anticipation', 'positive'], 'neat': ['positive'], 'necess': ['sadness'],
                     'need': ['negative'], 'needl': ['positive'], 'needi': ['negative'],
                     'nefari': ['disgust', 'fear', 'negative', 'sadness', 'surprise'], 'negat': ['anger', 'negative'],
                     'neglig': ['negative'], 'negoti': ['positive', 'trust'],
                     'nepot': ['anger', 'disgust', 'negative', 'sadness'], 'nerv': ['positive'],
                     'nestl': ['positive', 'trust'], 'nettl': ['anger', 'disgust', 'negative'],
                     'neurosi': ['fear', 'negative', 'sadness'], 'neurot': ['disgust', 'fear', 'negative'],
                     'newcom': ['fear', 'surprise'], 'nicotin': ['disgust', 'negative'],
                     'nightmar': ['fear', 'negative'], 'nihil': ['negative'],
                     'nobil': ['anticipation', 'positive', 'trust'], 'nobl': ['positive', 'trust'],
                     'nois': ['negative'], 'noisi': ['anger', 'negative'], 'nomin': ['positive'],
                     'noncompli': ['anger', 'anticipation', 'fear', 'negative', 'sadness'], 'nonsens': ['negative'],
                     'noos': ['negative', 'sadness'], 'normal': ['positive'], 'notabl': ['joy', 'positive', 'trust'],
                     'notari': ['trust'], 'note': ['positive'], 'nothing': ['negative', 'sadness'],
                     'notif': ['anticipation'], 'notorieti': ['anger', 'disgust', 'fear', 'negative', 'positive'],
                     'nourish': ['positive'], 'nuisanc': ['anger', 'negative'], 'nullifi': ['negative', 'surprise'],
                     'number': ['positive'], 'nurs': ['positive', 'trust'], 'nurseri': ['joy', 'positive', 'trust'],
                     'nurtur': ['anger', 'anticipation', 'disgust', 'fear', 'joy', 'positive', 'trust'],
                     'nutriti': ['positive', 'sadness'], 'oasi': ['anticipation', 'joy', 'positive', 'trust'],
                     'obedi': ['positive', 'trust'], 'obes': ['disgust', 'negative'],
                     'obituari': ['negative', 'sadness'], 'object': ['anger', 'negative'],
                     'oblig': ['negative', 'trust'], 'obliter': ['anger', 'fear', 'negative', 'sadness'],
                     'obnoxi': ['anger', 'disgust', 'negative', 'sadness'], 'obscen': ['disgust', 'negative'],
                     'obscur': ['negative'], 'observ': ['positive'],
                     'obstacl': ['anger', 'fear', 'negative', 'sadness'], 'obstin': ['negative'],
                     'obtain': ['joy', 'positive'], 'obtus': ['negative'], 'occasion': ['surprise'],
                     'occup': ['positive', 'trust'], 'occupi': ['positive'],
                     'odditi': ['disgust', 'negative', 'sadness', 'surprise'],
                     'offens': ['anger', 'disgust', 'fear', 'negative', 'sadness'], 'offic': ['positive', 'trust'],
                     'offici': ['trust'], 'of': ['negative'], 'ogr': ['disgust', 'fear', 'negative'],
                     'olfactori': ['anticipation', 'negative'], 'oligarchi': ['negative'],
                     'omin': ['anticipation', 'fear', 'negative'], 'omnipot': ['fear', 'negative', 'positive'],
                     'omnisci': ['positive', 'trust'], 'oner': ['anger', 'negative', 'sadness'],
                     'ongo': ['anticipation'], 'ooz': ['disgust', 'negative'], 'opaqu': ['negative'],
                     'open': ['positive'], 'operat': ['negative'], 'oper': ['fear', 'trust'], 'opiat': ['negative'],
                     'opinion': ['anger', 'negative'],
                     'oppon': ['anger', 'anticipation', 'disgust', 'fear', 'negative'], 'opportun': ['joy', 'positive'],
                     'oppos': ['negative'], 'opposit': ['anger', 'negative'],
                     'optim': ['anticipation', 'joy', 'positive', 'surprise', 'trust'],
                     'oracl': ['anticipation', 'positive', 'trust'], 'orat': ['positive'],
                     'ordain': ['positive', 'trust'], 'order': ['positive'], 'ordin': ['trust'],
                     'ordnanc': ['fear', 'negative'], 'origin': ['positive', 'surprise'], 'ornament': ['positive'],
                     'ornat': ['positive'], 'orthodoxi': ['trust'], 'ostens': ['negative'], 'outcom': ['positive'],
                     'outcri': ['anger', 'fear', 'negative', 'surprise'], 'outhous': ['disgust', 'negative'],
                     'outrag': ['anger', 'disgust', 'negative'], 'outsid': ['fear'],
                     'outstand': ['joy', 'negative', 'positive'], 'ovat': ['negative', 'sadness'],
                     'overbear': ['anger', 'negative'], 'overdos': ['negative'],
                     'overdu': ['anticipation', 'negative', 'sadness', 'surprise'], 'overestim': ['surprise'],
                     'overjoy': ['joy', 'positive'], 'overpow': ['negative'],
                     'overpr': ['anger', 'disgust', 'negative', 'sadness'], 'overtur': ['anticipation'],
                     'owe': ['anger', 'anticipation', 'disgust', 'fear', 'negative', 'sadness', 'trust'],
                     'oxid': ['negative'], 'pacif': ['positive'], 'paddl': ['anticipation', 'positive'],
                     'palat': ['positive'], 'palliat': ['positive'], 'palpabl': ['surprise'],
                     'palsi': ['disgust', 'fear', 'negative', 'sadness'], 'panach': ['positive'],
                     'pandem': ['fear', 'negative', 'sadness'], 'parachut': ['fear'],
                     'parad': ['anticipation', 'fear', 'joy', 'negative', 'positive', 'surprise'],
                     'paralysi': ['anger', 'anticipation', 'fear', 'negative', 'sadness'],
                     'paralyz': ['anger', 'fear', 'negative', 'sadness', 'surprise'],
                     'paraphras': ['negative', 'positive'], 'parasit': ['disgust', 'fear', 'negative'],
                     'parentag': ['positive'], 'pariet': ['positive', 'trust'], 'parol': ['anticipation'],
                     'parsimoni': ['negative'], 'partak': ['positive', 'trust'], 'particip': ['positive'],
                     'part': ['sadness'], 'pass': ['negative'], 'passeng': ['anticipation'], 'passiv': ['negative'],
                     'pastim': ['positive'], 'pastri': ['joy', 'positive'], 'pastur': ['positive'],
                     'pathet': ['disgust', 'negative', 'sadness'], 'patienc': ['anticipation', 'positive', 'trust'],
                     'patriarch': ['positive', 'trust'], 'patronag': ['positive', 'trust'],
                     'pauciti': ['anger', 'disgust', 'negative', 'sadness'],
                     'peac': ['anticipation', 'joy', 'positive', 'trust'], 'peaceabl': ['positive'],
                     'peculiar': ['negative'], 'pedigre': ['positive', 'trust'],
                     'penalti': ['anger', 'fear', 'negative', 'sadness'], 'penanc': ['fear', 'sadness'],
                     'penetr': ['anger', 'fear', 'negative'], 'penitentiari': ['anger', 'negative'],
                     'pensiv': ['sadness'], 'perceiv': ['positive', 'trust'], 'percept': ['positive'],
                     'perchanc': ['surprise'], 'perdit': ['anger', 'disgust', 'fear', 'negative', 'sadness'],
                     'perenni': ['positive', 'trust'], 'perform': ['positive'], 'period': ['trust'],
                     'perjuri': ['fear', 'negative', 'surprise'], 'permiss': ['positive'],
                     'pernici': ['anger', 'fear', 'negative', 'sadness'],
                     'perpetr': ['anger', 'disgust', 'fear', 'negative', 'sadness'], 'perpetu': ['anticipation'],
                     'perplex': ['negative'], 'persecut': ['anger', 'fear', 'negative'], 'persist': ['positive'],
                     'person': ['positive'], 'perspir': ['disgust'], 'persuad': ['trust'],
                     'pertin': ['positive', 'trust'], 'perturb': ['fear', 'negative'], 'pertussi': ['negative'],
                     'pervers': ['anger', 'disgust', 'fear', 'negative'],
                     'pessim': ['anger', 'fear', 'negative', 'sadness'], 'pestil': ['disgust', 'fear', 'negative'],
                     'petti': ['negative'], 'pharmaceut': ['positive'], 'philanthrop': ['trust'],
                     'philanthropi': ['positive'], 'philosoph': ['positive', 'trust'], 'phonet': ['positive'],
                     'phoni': ['anger', 'disgust', 'negative'], 'physic': ['positive'], 'physiolog': ['positive'],
                     'physiqu': ['positive'], 'pickl': ['negative'], 'picturesqu': ['joy', 'positive'],
                     'pieti': ['positive'], 'pile': ['disgust', 'negative'],
                     'pillag': ['anger', 'disgust', 'fear', 'negative'], 'pimpl': ['disgust', 'negative'],
                     'pinnacl': ['positive'], 'piqu': ['anger', 'negative'], 'piraci': ['negative'],
                     'pirat': ['anger', 'negative'],
                     'pitfal': ['anger', 'disgust', 'fear', 'negative', 'sadness', 'surprise'], 'piti': ['sadness'],
                     'plagiar': ['disgust', 'negative'], 'plagu': ['disgust', 'fear', 'negative', 'sadness'],
                     'plaintiv': ['sadness'], 'plate': ['negative'],
                     'play': ['anger', 'joy', 'positive', 'surprise', 'trust'], 'playhous': ['joy', 'positive'],
                     'pleas': ['joy', 'positive'], 'pleasur': ['joy', 'positive'],
                     'pledg': ['joy', 'positive', 'trust'], 'plenari': ['positive'], 'plenti': ['positive'],
                     'plod': ['negative'], 'plung': ['fear', 'negative'], 'pli': ['positive'],
                     'poach': ['anger', 'disgust', 'fear', 'negative', 'sadness'], 'point': ['positive'],
                     'polar': ['surprise'], 'polem': ['anger', 'disgust', 'negative'],
                     'polic': ['fear', 'positive', 'trust'], 'polici': ['trust'], 'polit': ['positive'],
                     'pollut': ['disgust', 'negative'], 'polygami': ['disgust', 'negative'], 'ponder': ['negative'],
                     'poor': ['negative'], 'popular': ['positive'], 'popul': ['positive'], 'porcupin': ['negative'],
                     'pornograph': ['negative'], 'pornographi': ['disgust', 'negative'], 'portabl': ['positive'],
                     'poss': ['fear'], 'possibl': ['anticipation'], 'posthum': ['negative', 'sadness'],
                     'postpon': ['negative', 'surprise'], 'potabl': ['positive'], 'potenc': ['positive'],
                     'poverti': ['anger', 'disgust', 'fear', 'negative', 'sadness'],
                     'power': ['anger', 'anticipation', 'disgust', 'fear', 'joy', 'positive', 'trust'],
                     'practic': ['positive'], 'practis': ['anticipation', 'positive'],
                     'prais': ['joy', 'positive', 'trust'],
                     'praiseworthi': ['anticipation', 'joy', 'positive', 'surprise', 'trust'],
                     'precari': ['anticipation', 'fear', 'negative', 'sadness'], 'precaut': ['positive'],
                     'preced': ['positive'], 'precipic': ['fear'], 'precis': ['positive'], 'preclud': ['anger'],
                     'predatori': ['negative'], 'predica': ['fear', 'negative'],
                     'predilect': ['anticipation', 'positive'], 'predispos': ['anticipation'],
                     'predomin': ['positive', 'trust'], 'preemin': ['positive'], 'pregnanc': ['disgust', 'negative'],
                     'prejudic': ['anger', 'negative'], 'prejud': ['disgust', 'fear', 'negative'],
                     'prejudici': ['anger', 'negative'], 'preliminari': ['anticipation'], 'prematur': ['surprise'],
                     'premedit': ['fear', 'negative'], 'premis': ['positive'], 'prepar': ['anticipation'],
                     'preparatori': ['anticipation'], 'preponder': ['trust'], 'prerequisit': ['anticipation'],
                     'presenc': ['positive'], 'preserv': ['anticipation', 'joy', 'positive', 'surprise', 'trust'],
                     'presid': ['positive', 'trust'], 'pressur': ['negative'], 'prestig': ['joy', 'positive', 'trust'],
                     'presumpt': ['trust'], 'presumptu': ['anger', 'disgust', 'negative'], 'pretens': ['negative'],
                     'pretti': ['anticipation', 'joy', 'positive', 'trust'], 'preval': ['trust'],
                     'primaci': ['positive'], 'primari': ['positive'], 'princ': ['positive'],
                     'princip': ['positive', 'trust'], 'pristin': ['positive'],
                     'privileg': ['joy', 'positive', 'trust'], 'privi': ['negative', 'trust'],
                     'probabl': ['anticipation'], 'probat': ['anticipation', 'fear', 'sadness'],
                     'probiti': ['positive', 'trust'], 'procedur': ['fear', 'positive'], 'proceed': ['anticipation'],
                     'process': ['joy', 'positive', 'sadness', 'surprise'], 'procrastin': ['negative'],
                     'procur': ['positive'], 'prodig': ['negative', 'positive'], 'prodigi': ['positive'],
                     'produc': ['positive'], 'product': ['anticipation', 'positive'], 'profan': ['anger', 'negative'],
                     'profess': ['positive'], 'profici': ['anticipation', 'joy', 'positive', 'surprise', 'trust'],
                     'profus': ['positive'], 'prognosi': ['anticipation', 'fear'], 'prognost': ['anticipation'],
                     'prohibit': ['anger', 'disgust', 'fear', 'negative'], 'projectil': ['fear'],
                     'prolif': ['positive'], 'prologu': ['anticipation'], 'promin': ['positive'],
                     'promiscu': ['negative'], 'promis': ['joy', 'positive', 'trust'], 'promot': ['positive'],
                     'propheci': ['anticipation'], 'prophylact': ['anticipation', 'positive', 'trust'],
                     'proposit': ['positive'], 'prosecut': ['anger', 'fear', 'negative', 'sadness'],
                     'prostitut': ['disgust', 'negative'], 'protest': ['fear'], 'proverbi': ['positive'],
                     'provid': ['positive', 'trust'], 'provoc': ['anger', 'negative'],
                     'provok': ['anger', 'disgust', 'negative'], 'proxi': ['trust'], 'prudenc': ['positive'],
                     'pri': ['anger', 'anticipation', 'negative', 'trust'],
                     'psychosi': ['anger', 'fear', 'negative', 'sadness'], 'puffi': ['negative'],
                     'punit': ['anger', 'fear', 'negative', 'sadness'], 'puppi': ['anticipation', 'positive', 'trust'],
                     'pure': ['positive', 'trust'], 'purgatori': ['disgust', 'fear', 'negative'],
                     'purg': ['fear', 'negative'], 'purif': ['positive', 'trust'],
                     'purifi': ['joy', 'positive', 'trust'], 'puriti': ['positive', 'surprise'], 'putat': ['trust'],
                     'quagmir': ['disgust', 'negative'], 'quak': ['fear'], 'qualifi': ['positive', 'trust'],
                     'quandari': ['anger', 'fear', 'negative'], 'quarantin': ['fear'],
                     'quick': ['positive', 'surprise'], 'quicksilv': ['negative', 'surprise'], 'quinin': ['positive'],
                     'quot': ['anticipation', 'negative', 'positive', 'surprise'],
                     'rabbl': ['anger', 'fear', 'negative'], 'rabi': ['negative'],
                     'radianc': ['anticipation', 'joy', 'positive', 'trust'], 'radiat': ['positive'],
                     'radioact': ['fear', 'negative'], 'raffl': ['anticipation', 'surprise'],
                     'rag': ['disgust', 'negative'], 'raini': ['sadness'], 'rambl': ['negative'],
                     'rampag': ['anger', 'fear', 'negative'], 'random': ['surprise'], 'rap': ['anger'],
                     'raptor': ['fear', 'negative'], 'raptur': ['anticipation', 'joy', 'positive'],
                     'rariti': ['surprise'], 'ratifi': ['trust'], 'rate': ['anger', 'fear', 'negative', 'sadness'],
                     'ration': ['positive', 'trust'], 'rattlesnak': ['fear'],
                     'raven': ['anger', 'fear', 'negative', 'sadness'], 'ravin': ['fear'], 'reactionari': ['negative'],
                     'readili': ['positive'], 'readi': ['anticipation', 'joy', 'positive', 'trust'],
                     'read': ['positive'], 'reassur': ['positive', 'trust'], 'rebat': ['positive'],
                     'rebuk': ['negative'], 'recalcitr': ['anger', 'disgust', 'negative'], 'receiv': ['positive'],
                     'recess': ['fear'], 'recherch': ['positive'],
                     'recidiv': ['anger', 'disgust', 'negative', 'sadness'], 'recipi': ['anticipation'],
                     'reciproc': ['positive'], 'reclam': ['positive'], 'reclin': ['positive', 'trust'],
                     'recogniz': ['anticipation', 'positive'], 'recombin': ['anticipation'],
                     'reconcili': ['anticipation', 'joy', 'positive', 'trust'], 'reconsider': ['positive', 'trust'],
                     'record': ['positive'], 'recoveri': ['positive'], 'recreat': ['anticipation', 'joy', 'positive'],
                     'recruit': ['trust'], 'rectifi': ['positive'], 'recurr': ['anticipation'], 'redempt': ['positive'],
                     'redund': ['negative'], 'refere': ['trust'], 'refin': ['positive'], 'refractori': ['negative'],
                     'refresh': ['positive'], 'refuge': ['sadness'], 'refus': ['negative'], 'refut': ['fear'],
                     'registri': ['trust'], 'regrett': ['negative', 'sadness'],
                     'regular': ['anticipation', 'positive', 'trust'], 'regul': ['positive'],
                     'regulatori': ['fear', 'negative'], 'regurgit': ['disgust'], 'rehabilit': ['positive'],
                     'reimburs': ['positive'], 'reinforc': ['positive', 'trust'], 'reinstat': ['positive'],
                     'rejoic': ['anticipation', 'joy', 'positive', 'surprise', 'trust'], 'rejuven': ['positive'],
                     'rekindl': ['anticipation', 'fear', 'joy', 'negative', 'positive', 'surprise'],
                     'relaps': ['fear', 'negative', 'sadness'], 'relat': ['trust'], 'relax': ['positive'],
                     'releg': ['negative'], 'relev': ['positive', 'trust'], 'reliabl': ['positive', 'trust'],
                     'relianc': ['positive', 'trust'], 'relic': ['sadness'], 'reliev': ['positive'],
                     'reluct': ['fear', 'negative'], 'remain': ['disgust', 'fear', 'negative', 'positive', 'trust'],
                     'remak': ['positive'], 'remark': ['joy', 'positive', 'surprise', 'trust'], 'remedi': ['negative'],
                     'remors': ['negative', 'sadness'], 'remov': ['negative'], 'renaiss': ['positive'],
                     'rencontr': ['negative'], 'renegad': ['anger', 'negative'], 'renew': ['positive'],
                     'renounc': ['anger', 'negative'], 'renov': ['anticipation', 'positive'], 'renunci': ['negative'],
                     'reorgan': ['positive'], 'repar': ['positive', 'trust'], 'repel': ['disgust', 'fear', 'negative'],
                     'replet': ['positive'], 'report': ['positive', 'trust'], 'repos': ['positive'],
                     'repres': ['positive'], 'repris': ['anger', 'fear', 'negative', 'sadness'],
                     'reproduct': ['joy', 'positive'], 'republ': ['negative'],
                     'repudi': ['anger', 'disgust', 'negative'], 'repuls': ['disgust', 'fear', 'negative'],
                     'reput': ['positive', 'trust'], 'resciss': ['negative'],
                     'rescu': ['anticipation', 'joy', 'positive', 'surprise', 'trust'], 'resect': ['fear'],
                     'reserv': ['positive'], 'resid': ['positive'], 'resili': ['positive'], 'resolut': ['positive'],
                     'resourc': ['joy', 'positive', 'trust'], 'respit': ['joy', 'positive', 'trust'],
                     'resplend': ['joy', 'positive'], 'respons': ['positive', 'trust'],
                     'restitut': ['anger', 'positive'], 'restless': ['anticipation'],
                     'restor': ['anticipation', 'joy', 'positive', 'trust'], 'resumpt': ['positive'],
                     'retali': ['anger', 'negative'], 'retaliatori': ['anger', 'negative'], 'retent': ['positive'],
                     'retic': ['fear', 'negative'],
                     'retir': ['anticipation', 'fear', 'joy', 'negative', 'positive', 'sadness', 'trust'],
                     'retrench': ['fear', 'negative'], 'retribut': ['anger', 'fear', 'negative', 'sadness'],
                     'retrograd': ['negative'], 'reveng': ['anger', 'anticipation', 'fear', 'negative', 'surprise'],
                     'rever': ['anticipation', 'joy', 'positive', 'trust'], 'reveri': ['joy', 'positive', 'trust'],
                     'revers': ['anger', 'disgust', 'negative', 'surprise'], 'revis': ['positive'],
                     'reviv': ['anticipation', 'joy', 'positive', 'trust'], 'revoc': ['negative'],
                     'revok': ['anger', 'disgust', 'fear', 'negative', 'sadness'],
                     'revolut': ['anger', 'anticipation', 'fear', 'negative', 'positive', 'sadness', 'surprise'],
                     'revolutionari': ['positive'], 'revolv': ['anger', 'fear', 'negative', 'sadness'],
                     'revuls': ['anger', 'disgust', 'fear', 'negative'],
                     'rheumat': ['anger', 'fear', 'negative', 'sadness'], 'rhythmic': ['joy', 'positive', 'surprise'],
                     'rich': ['positive'], 'ricketi': ['negative'], 'riddl': ['surprise'],
                     'ridicul': ['anger', 'disgust', 'negative', 'sadness'], 'rifl': ['anger', 'fear', 'negative'],
                     'right': ['positive'], 'rise': ['anticipation', 'joy', 'positive'],
                     'riski': ['anticipation', 'fear', 'negative'], 'rivalri': ['anger', 'negative'],
                     'rivet': ['positive'], 'robberi': ['anger', 'disgust', 'fear', 'negative', 'sadness'],
                     'rogu': ['disgust', 'negative'], 'rollick': ['joy', 'positive'],
                     'romanc': ['anticipation', 'fear', 'joy', 'positive', 'sadness', 'surprise', 'trust'],
                     'romant': ['anticipation', 'joy', 'positive', 'trust'], 'root': ['positive', 'trust'],
                     'rosi': ['positive'], 'rough': ['negative'], 'roulett': ['anticipation'],
                     'routin': ['positive', 'trust'], 'rowdi': ['negative'], 'royalti': ['positive'],
                     'rubbl': ['fear', 'negative', 'sadness'], 'ruffl': ['negative'], 'rug': ['negative'],
                     'ruptur': ['fear', 'negative', 'sadness', 'surprise'], 'rusti': ['negative'],
                     'sabotag': ['anger', 'disgust', 'fear', 'negative', 'sadness', 'surprise'],
                     'sacrific': ['disgust', 'fear', 'negative', 'sadness'], 'sad': ['negative', 'sadness'],
                     'safekeep': ['trust'], 'salari': ['anticipation', 'joy', 'positive', 'trust'],
                     'salli': ['surprise'], 'salutari': ['joy', 'positive', 'trust'], 'salut': ['joy', 'positive'],
                     'salvat': ['anticipation', 'joy', 'positive', 'trust'], 'salv': ['positive'],
                     'sanctif': ['joy', 'positive', 'trust'],
                     'sanctifi': ['anticipation', 'joy', 'positive', 'sadness', 'surprise', 'trust'],
                     'sanctuari': ['anticipation', 'joy', 'positive', 'trust'], 'sanguin': ['positive'],
                     'sanitari': ['positive'], 'sappi': ['trust'], 'sardon': ['negative'],
                     'satan': ['anger', 'negative'], 'satisfactorili': ['positive'], 'satisfi': ['joy', 'positive'],
                     'satur': ['disgust', 'negative'], 'savag': ['anger', 'fear', 'negative'],
                     'savageri': ['anger', 'fear', 'negative'], 'savori': ['positive'], 'savvi': ['positive'],
                     'scali': ['negative'], 'scanti': ['negative'], 'scarc': ['fear', 'negative', 'sadness'],
                     'scarciti': ['anger', 'fear', 'negative', 'sadness'], 'scaveng': ['negative'],
                     'sceptic': ['trust'], 'scientif': ['positive', 'trust'], 'scorch': ['anger', 'negative'],
                     'scourg': ['anger', 'fear', 'negative', 'sadness'], 'scrambl': ['negative'],
                     'scrapi': ['anger', 'fear', 'negative', 'sadness'], 'screw': ['anger', 'negative'],
                     'scrimmag': ['negative', 'surprise'], 'scriptur': ['trust'],
                     'scrutin': ['anticipation', 'negative'], 'scrutini': ['negative'], 'sculptur': ['positive'],
                     'season': ['positive'], 'secess': ['negative'], 'seclud': ['negative', 'sadness'],
                     'seclus': ['fear', 'negative', 'positive'], 'secreci': ['surprise', 'trust'], 'secur': ['trust'],
                     'sedit': ['anger', 'negative', 'sadness'], 'seduc': ['negative'], 'seduct': ['negative'],
                     'segreg': ['anger', 'disgust', 'negative', 'sadness'], 'seiz': ['fear', 'negative'],
                     'seizur': ['fear'], 'senat': ['trust'], 'senil': ['fear', 'negative', 'sadness'],
                     'senior': ['positive', 'trust'], 'sensat': ['joy', 'positive'], 'sens': ['positive'],
                     'sensibl': ['positive'],
                     'sentenc': ['anger', 'anticipation', 'disgust', 'fear', 'negative', 'sadness'],
                     'sentiment': ['positive'], 'sentri': ['trust'], 'sepsi': ['fear', 'negative', 'sadness'],
                     'sequestr': ['negative', 'sadness'], 'seren': ['negative', 'trust'], 'seri': ['trust'],
                     'serious': ['fear', 'sadness'], 'serv': ['negative', 'trust'],
                     'servil': ['disgust', 'fear', 'negative', 'sadness'], 'servitud': ['negative'],
                     'sewag': ['disgust', 'negative'], 'sewerag': ['disgust', 'negative'],
                     'shabbi': ['disgust', 'negative'],
                     'shackl': ['anger', 'anticipation', 'disgust', 'fear', 'negative', 'sadness'],
                     'shadi': ['fear', 'negative'], 'shake': ['fear', 'negative'],
                     'shaki': ['anger', 'anticipation', 'fear', 'negative'], 'shambl': ['negative'],
                     'shelv': ['negative'], 'shoddi': ['anger', 'disgust', 'negative'], 'shopkeep': ['trust'],
                     'shoplift': ['anger', 'disgust', 'negative'],
                     'shop': ['anticipation', 'joy', 'positive', 'surprise', 'trust'],
                     'shortag': ['anger', 'fear', 'negative', 'sadness'], 'shortcom': ['negative'],
                     'short': ['anticipation'], 'showi': ['negative'],
                     'sicken': ['anger', 'disgust', 'fear', 'negative', 'sadness'], 'signatur': ['trust'],
                     'signifi': ['anticipation'], 'silli': ['joy', 'negative'],
                     'simplifi': ['anticipation', 'joy', 'positive', 'surprise', 'trust'],
                     'sincer': ['positive', 'trust'], 'singl': ['positive'], 'singular': ['surprise'],
                     'sinist': ['anger', 'disgust', 'fear', 'negative'], 'sissi': ['negative'], 'sizzl': ['anger'],
                     'skeptic': ['negative'], 'sketchi': ['negative'], 'skew': ['anger', 'anticipation', 'negative'],
                     'skill': ['positive'], 'slaughterhous': ['anger', 'disgust', 'fear', 'negative', 'sadness'],
                     'slaveri': ['anger', 'disgust', 'fear', 'negative', 'sadness'], 'slimi': ['disgust', 'negative'],
                     'sloppi': ['disgust', 'negative'], 'slow': ['negative'], 'sludg': ['disgust', 'negative'],
                     'sli': ['anger', 'disgust', 'fear', 'negative'], 'smatter': ['negative'], 'smooth': ['positive'],
                     'smudg': ['negative'], 'smuggl': ['fear', 'negative'],
                     'sneez': ['disgust', 'negative', 'surprise'], 'sobrieti': ['positive', 'trust'],
                     'sociabl': ['positive'], 'social': ['disgust', 'fear'], 'solac': ['positive'],
                     'solidar': ['trust'], 'solut': ['positive'], 'solvenc': ['positive'],
                     'somat': ['negative', 'surprise'], 'sonor': ['joy', 'positive'], 'sooth': ['positive'],
                     'sorceri': ['anticipation', 'fear', 'negative', 'surprise'], 'sorti': ['fear', 'negative'],
                     'soulmat': ['fear', 'negative'], 'sound': ['anticipation', 'joy', 'positive', 'trust'],
                     'sparkl': ['anticipation', 'joy', 'positive', 'surprise'], 'speci': ['positive'],
                     'spectacl': ['negative', 'positive'], 'specul': ['fear', 'negative', 'sadness'],
                     'speedi': ['positive'], 'spell': ['positive'], 'spong': ['negative'],
                     'spous': ['joy', 'positive', 'trust'], 'stabl': ['positive', 'trust'],
                     'stalem': ['anger', 'disgust'], 'stand': ['positive'], 'standstil': ['anger', 'negative'],
                     'stare': ['negative'], 'starri': ['anticipation', 'joy', 'positive'],
                     'startl': ['fear', 'negative', 'surprise'], 'starvat': ['fear', 'negative', 'sadness'],
                     'starv': ['negative'], 'state': ['positive'], 'stationari': ['negative'], 'statist': ['trust'],
                     'statu': ['positive'], 'steadi': ['surprise', 'trust'], 'stealthili': ['surprise'],
                     'stealthi': ['anticipation', 'fear', 'negative', 'surprise'], 'stereotyp': ['negative'],
                     'steril': ['negative', 'sadness'],
                     'sterl': ['anger', 'anticipation', 'joy', 'negative', 'positive', 'trust'], 'sticki': ['disgust'],
                     'stifl': ['negative'], 'still': ['fear', 'positive', 'sadness'],
                     'stingi': ['anger', 'disgust', 'fear', 'negative', 'sadness'], 'stock': ['negative'],
                     'stool': ['disgust', 'negative'], 'stoppag': ['negative'], 'stormi': ['fear', 'negative'],
                     'strain': ['anger', 'negative'], 'strait': ['fear', 'negative'], 'strand': ['negative'],
                     'strangl': ['anger', 'disgust', 'fear', 'negative', 'sadness', 'surprise'],
                     'strateg': ['positive'], 'strong': ['positive'], 'structur': ['trust'],
                     'struggl': ['anger', 'fear', 'negative', 'sadness'], 'studi': ['positive'], 'stuffi': ['negative'],
                     'stumbl': ['negative'], 'stun': ['fear', 'negative', 'surprise'], 'stunt': ['negative'],
                     'sturdi': ['positive'], 'sti': ['disgust', 'negative'], 'subdu': ['negative'],
                     'subjug': ['anger', 'disgust', 'fear', 'negative', 'sadness'], 'sublim': ['joy', 'positive'],
                     'subordin': ['fear', 'negative'], 'subscrib': ['anticipation'], 'subsid': ['negative', 'sadness'],
                     'subsidi': ['anger', 'disgust', 'negative'], 'substanc': ['positive'], 'substanti': ['trust'],
                     'substant': ['positive'], 'subvers': ['anger', 'fear', 'negative'],
                     'succul': ['negative', 'positive'], 'suffici': ['positive'],
                     'suffoc': ['disgust', 'fear', 'negative', 'sadness'],
                     'suicid': ['anger', 'disgust', 'fear', 'negative', 'sadness'], 'suitabl': ['positive'],
                     'sultri': ['positive'], 'summon': ['negative'],
                     'sunni': ['anticipation', 'joy', 'positive', 'surprise'], 'sunshin': ['joy', 'positive'],
                     'superfici': ['negative'], 'superflu': ['negative'], 'superstit': ['fear', 'negative', 'positive'],
                     'superstiti': ['anticipation', 'fear', 'negative'], 'supplic': ['positive', 'trust'],
                     'suppli': ['positive'], 'support': ['positive'],
                     'supremaci': ['anger', 'anticipation', 'fear', 'joy', 'negative', 'positive', 'surprise', 'trust'],
                     'suprem': ['positive'], 'surcharg': ['anger', 'negative'], 'sureti': ['positive', 'trust'],
                     'surg': ['surprise'], 'surgeri': ['fear', 'sadness'], 'sur': ['anger', 'disgust', 'negative'],
                     'surmis': ['positive'], 'surpass': ['positive'],
                     'surpris': ['fear', 'joy', 'positive', 'surprise'], 'surrend': ['fear', 'negative', 'sadness'],
                     'surrog': ['trust'], 'surveil': ['fear'], 'survey': ['positive'], 'surviv': ['positive'],
                     'suscept': ['negative'], 'suspens': ['anticipation', 'fear', 'surprise'],
                     'suspici': ['anger', 'anticipation', 'negative'], 'swampi': ['disgust', 'fear', 'negative'],
                     'sweeti': ['positive'], 'swell': ['fear', 'negative'], 'swerv': ['fear', 'surprise'],
                     'symbol': ['positive'], 'symmetr': ['positive'], 'symmetri': ['joy', 'positive', 'trust'],
                     'sympathet': ['fear', 'joy', 'positive', 'sadness', 'trust'], 'sympath': ['sadness'],
                     'sympathi': ['positive', 'sadness'], 'symphoni': ['anticipation', 'joy', 'positive'],
                     'synchron': ['anticipation', 'joy', 'positive', 'surprise', 'trust'],
                     'syncop': ['fear', 'negative', 'sadness', 'surprise'], 'synergist': ['positive', 'trust'],
                     'synonym': ['fear', 'negative', 'positive', 'trust'], 'syring': ['fear'],
                     'tabul': ['anticipation'], 'tackl': ['anger', 'surprise'], 'tactic': ['fear', 'trust'],
                     'talon': ['anger', 'fear', 'negative'], 'tangl': ['negative'], 'tan': ['positive'],
                     'tantal': ['anticipation', 'joy', 'negative', 'positive', 'surprise'], 'tardi': ['negative'],
                     'tarri': ['negative'], 'tast': ['positive'], 'tasti': ['positive'], 'tawni': ['disgust'],
                     'tear': ['disgust', 'fear', 'sadness'], 'teas': ['anger', 'anticipation', 'negative', 'sadness'],
                     'technolog': ['positive'], 'teem': ['disgust'], 'teen': ['negative', 'positive'],
                     'temper': ['positive'], 'temptat': ['negative'], 'tenabl': ['positive'], 'tenaci': ['positive'],
                     'tenac': ['positive'], 'tenanc': ['positive'], 'termin': ['fear', 'negative', 'sadness'],
                     'termit': ['disgust', 'negative'], 'terribl': ['anger', 'disgust', 'fear', 'negative', 'sadness'],
                     'terrif': ['sadness'], 'testimoni': ['trust'], 'thank': ['joy', 'positive'],
                     'thanksgiv': ['joy', 'positive'], 'theocrat': ['anger', 'fear', 'negative', 'sadness', 'trust'],
                     'theolog': ['trust'], 'theoret': ['positive'], 'theori': ['anticipation', 'trust'],
                     'therapeut': ['joy', 'positive', 'trust'], 'thermocoupl': ['anticipation'], 'thermomet': ['trust'],
                     'thirsti': ['negative'], 'thorni': ['fear', 'negative'], 'thoroughbr': ['positive'],
                     'thrive': ['anticipation', 'joy', 'positive'], 'throttl': ['anger', 'negative'],
                     'thunder': ['anger', 'fear', 'negative'],
                     'tickl': ['anticipation', 'joy', 'positive', 'surprise', 'trust'], 'tile': ['positive'],
                     'tipsi': ['negative'], 'tirad': ['anger', 'disgust', 'negative'], 'tire': ['negative'],
                     'tiresom': ['negative'], 'titl': ['positive', 'trust'], 'toil': ['negative'],
                     'toler': ['positive'], 'toothach': ['fear', 'negative'], 'toppl': ['surprise'],
                     'tortur': ['anger', 'anticipation', 'disgust', 'fear', 'negative', 'sadness'],
                     'touch': ['negative'], 'touchi': ['anger', 'negative', 'sadness'], 'tradit': ['positive'],
                     'tragedi': ['fear', 'negative', 'sadness'], 'tranc': ['negative'], 'transact': ['trust'],
                     'transcend': ['anticipation', 'joy', 'positive', 'surprise', 'trust'],
                     'transcendent': ['positive'], 'transgress': ['negative'], 'transit': ['anticipation'],
                     'translat': ['trust'], 'trap': ['negative'], 'trashi': ['disgust', 'negative'],
                     'traumat': ['anger', 'fear', 'negative', 'sadness'], 'travel': ['positive'],
                     'travesti': ['disgust', 'fear', 'negative', 'sadness'],
                     'treacher': ['anger', 'disgust', 'fear', 'negative'],
                     'treacheri': ['anger', 'fear', 'negative', 'sadness', 'surprise'], 'treadmil': ['anticipation'],
                     'treasur': ['anticipation', 'joy', 'positive', 'trust'], 'trembl': ['fear', 'negative'],
                     'tremend': ['positive'], 'trendi': ['positive'],
                     'trepid': ['anticipation', 'fear', 'negative', 'surprise'],
                     'tribul': ['fear', 'negative', 'sadness'],
                     'tribun': ['anticipation', 'disgust', 'fear', 'negative', 'trust'],
                     'tributari': ['anticipation', 'positive'], 'tribut': ['positive'],
                     'trickeri': ['anger', 'disgust', 'fear', 'negative', 'sadness', 'surprise'], 'trifl': ['negative'],
                     'trophi': ['anticipation', 'joy', 'positive', 'surprise', 'trust'],
                     'troublesom': ['anger', 'fear', 'negative'], 'truste': ['trust'], 'trusti': ['positive'],
                     'tumbl': ['negative'], 'tumultu': ['anger', 'fear', 'negative'],
                     'turbul': ['anger', 'fear', 'negative'], 'tussl': ['anger'], 'tutelag': ['positive', 'trust'],
                     'twinkl': ['anticipation', 'joy', 'positive'], 'tyrann': ['anger', 'disgust', 'fear', 'negative'],
                     'tyranni': ['fear', 'negative', 'sadness'], 'ugli': ['disgust', 'fear', 'negative', 'sadness'],
                     'ultim': ['anticipation', 'sadness'], 'umpir': ['positive', 'trust'],
                     'unabl': ['negative', 'sadness'], 'unaccept': ['negative', 'sadness'],
                     'unaccount': ['anticipation', 'disgust', 'negative', 'sadness', 'trust'],
                     'unacknowledg': ['sadness'], 'unanim': ['positive'], 'unanticip': ['surprise'],
                     'unapprov': ['negative'], 'unassum': ['positive'], 'unattach': ['negative'],
                     'unattain': ['anger', 'negative', 'sadness'], 'unattract': ['disgust', 'negative', 'sadness'],
                     'unauthor': ['negative'], 'unavoid': ['negative'], 'unawar': ['negative'],
                     'unbear': ['disgust', 'negative', 'sadness'], 'unbeliev': ['negative'], 'unbias': ['positive'],
                     'unbreak': ['positive'],
                     'unbridl': ['anger', 'anticipation', 'fear', 'negative', 'positive', 'surprise'],
                     'uncanni': ['fear', 'negative', 'surprise'], 'uncar': ['anger', 'disgust', 'negative', 'sadness'],
                     'unchang': ['negative'], 'uncomfort': ['negative'], 'unconscion': ['disgust', 'negative'],
                     'unconsci': ['negative'], 'unconstitut': ['negative'], 'unconstrain': ['joy', 'positive'],
                     'uncontrol': ['anger', 'anticipation', 'negative', 'surprise'], 'uncov': ['surprise'],
                     'undecid': ['anticipation', 'fear', 'negative'], 'underestim': ['surprise'],
                     'underlin': ['positive'], 'undermin': ['negative'], 'unders': ['negative'],
                     'understand': ['positive', 'trust'], 'undertak': ['sadness'], 'underwrit': ['positive', 'trust'],
                     'undesir': ['anger', 'disgust', 'fear', 'negative', 'sadness'], 'undisclos': ['anticipation'],
                     'undiscov': ['surprise'], 'undivid': ['positive'], 'undoubt': ['anticipation', 'disgust'],
                     'undi': ['anticipation', 'joy', 'positive', 'sadness', 'trust'],
                     'uneasi': ['anticipation', 'negative', 'sadness'], 'uneduc': ['negative', 'sadness'],
                     'unemploy': ['fear', 'negative', 'sadness'],
                     'unequ': ['anger', 'disgust', 'fear', 'negative', 'sadness'], 'unequivoc': ['trust'],
                     'unexpect': ['anticipation', 'fear', 'joy', 'negative', 'positive', 'surprise'],
                     'unexplain': ['anticipation', 'negative', 'sadness'], 'unfaith': ['disgust', 'negative'],
                     'unfavor': ['disgust', 'negative', 'sadness'], 'unfinish': ['negative'],
                     'unforgiv': ['anger', 'negative', 'sadness'], 'unfortun': ['negative', 'sadness'],
                     'unfriend': ['anger', 'disgust', 'fear', 'negative', 'sadness'],
                     'unfulfil': ['anger', 'anticipation', 'negative', 'sadness', 'surprise'],
                     'unfurnish': ['negative'], 'ungod': ['negative', 'sadness'],
                     'ungrat': ['anger', 'disgust', 'negative'], 'unguard': ['surprise'],
                     'unhappi': ['negative', 'sadness'], 'unhealthi': ['disgust', 'fear', 'negative', 'sadness'],
                     'unholi': ['fear', 'negative'], 'unif': ['anticipation', 'joy', 'positive', 'trust'],
                     'uniform': ['positive'], 'unimagin': ['negative', 'positive', 'surprise'],
                     'unimport': ['negative', 'sadness'], 'unimpress': ['negative'], 'unimprov': ['negative'],
                     'uninfect': ['positive'], 'uninform': ['negative'], 'uniniti': ['negative'],
                     'uninspir': ['negative', 'sadness'], 'unintellig': ['negative'], 'unintend': ['surprise'],
                     'unintent': ['surprise'], 'uninterest': ['negative', 'sadness'], 'uninvit': ['sadness'],
                     'uniqu': ['positive', 'surprise'], 'unitari': ['positive'], 'unit': ['positive', 'trust'],
                     'uniti': ['positive', 'trust'], 'univers': ['anticipation', 'positive'],
                     'unjustifi': ['anger', 'disgust', 'fear', 'negative'],
                     'unlaw': ['anger', 'disgust', 'fear', 'negative', 'sadness'], 'unlicens': ['negative'],
                     'unlimit': ['positive'], 'unlucki': ['anger', 'disgust', 'fear', 'negative', 'sadness'],
                     'unmanag': ['disgust', 'negative'], 'unnatur': ['disgust', 'fear', 'negative'],
                     'unoffici': ['negative'], 'unpleas': ['disgust', 'negative', 'sadness'], 'unpreced': ['surprise'],
                     'unpredict': ['negative', 'surprise'], 'unprepar': ['negative'], 'unpretenti': ['positive'],
                     'unproduct': ['negative'], 'unprofit': ['negative'], 'unprotect': ['negative'],
                     'unpublish': ['anticipation', 'negative', 'sadness'], 'unquestion': ['positive', 'trust'],
                     'unquest': ['positive', 'trust'], 'unreli': ['negative', 'trust'],
                     'unrequit': ['negative', 'sadness'], 'unresolv': ['anticipation'],
                     'unruli': ['anger', 'disgust', 'fear', 'negative'], 'unsaf': ['fear', 'negative'],
                     'unsatisfactori': ['disgust', 'negative'], 'unsatisfi': ['disgust', 'negative', 'sadness'],
                     'unsavori': ['negative'], 'unscath': ['positive'], 'unscrupul': ['negative'],
                     'unsettl': ['anger', 'disgust', 'fear', 'negative'], 'unsight': ['disgust', 'negative'],
                     'unsophist': ['negative'], 'unspeak': ['fear', 'negative'],
                     'unstabl': ['fear', 'negative', 'surprise'], 'unsteadi': ['fear'],
                     'unsuccess': ['negative', 'sadness'], 'unsuit': ['negative'], 'unsupport': ['negative'],
                     'unsurpass': ['anticipation', 'fear', 'joy', 'positive', 'trust'], 'unsuspect': ['surprise'],
                     'unsustain': ['negative'], 'unsympathet': ['anger', 'negative'], 'untam': ['negative'],
                     'unten': ['negative'], 'unthink': ['anger', 'disgust', 'fear', 'negative'],
                     'untidi': ['disgust', 'negative'], 'unti': ['joy', 'negative', 'positive'], 'untim': ['negative'],
                     'untitl': ['negative', 'sadness'], 'untrain': ['negative'], 'untru': ['negative'],
                     'untrustworthi': ['anger', 'negative'], 'unverifi': ['anticipation'], 'unwarr': ['negative'],
                     'unwash': ['disgust', 'negative'], 'unwav': ['positive', 'trust'],
                     'unwelcom': ['negative', 'sadness'], 'unwel': ['negative', 'sadness'], 'unwilling': ['negative'],
                     'unwis': ['negative'], 'unwit': ['negative'], 'unworthi': ['disgust', 'negative'],
                     'unyield': ['negative'], 'upheav': ['anger', 'fear', 'negative', 'sadness'],
                     'uphil': ['anticipation', 'fear', 'negative', 'positive'],
                     'upris': ['anger', 'anticipation', 'fear', 'negative'],
                     'urgenc': ['anticipation', 'fear', 'surprise'], 'use': ['positive'], 'usuri': ['negative'],
                     'util': ['positive'], 'vacanc': ['negative'], 'vacat': ['anticipation', 'joy', 'positive'],
                     'vaccin': ['positive'], 'vagu': ['negative'], 'vain': ['disgust', 'negative', 'sadness'],
                     'valid': ['fear'], 'valuabl': ['positive'], 'vampir': ['anger', 'disgust', 'fear', 'negative'],
                     'vaniti': ['negative'], 'variabl': ['surprise'], 'varicos': ['negative'],
                     'veget': ['disgust', 'negative', 'sadness'], 'velveti': ['positive'],
                     'vener': ['anticipation', 'joy', 'positive', 'trust'], 'vengeanc': ['anger', 'negative'],
                     'veng': ['anger', 'fear', 'negative'],
                     'verac': ['anticipation', 'joy', 'positive', 'surprise', 'trust'], 'verbos': ['negative'],
                     'verg': ['anticipation', 'fear', 'negative'], 'verif': ['positive', 'trust'],
                     'verifi': ['positive', 'trust'], 'verili': ['positive', 'trust'], 'verit': ['positive'],
                     'verv': ['positive'], 'victori': ['joy', 'positive'], 'villag': ['positive', 'trust'],
                     'vindic': ['anger'], 'vindict': ['anger', 'disgust', 'negative'],
                     'violat': ['anger', 'fear', 'negative', 'sadness', 'surprise'],
                     'violenc': ['anger', 'fear', 'negative', 'sadness'], 'virtu': ['positive', 'trust'],
                     'virul': ['anger', 'fear', 'negative'], 'visionari': ['anticipation', 'joy', 'positive', 'trust'],
                     'vivaci': ['joy', 'positive'], 'vocabulari': ['positive'],
                     'volatil': ['anger', 'anticipation', 'fear', 'negative', 'surprise'],
                     'volunt': ['anticipation', 'fear', 'joy', 'positive', 'trust'],
                     'voluptu': ['anticipation', 'joy', 'positive'], 'votiv': ['trust'], 'voyag': ['anticipation'],
                     'vulner': ['fear', 'negative', 'sadness'], 'vultur': ['disgust', 'fear', 'negative'],
                     'waffl': ['anger', 'negative', 'sadness'], 'wage': ['joy', 'positive'],
                     'want': ['negative', 'sadness'], 'warfar': ['anger', 'fear', 'negative', 'sadness'],
                     'warlik': ['anger', 'fear', 'negative'], 'warranti': ['positive', 'trust'], 'wari': ['fear'],
                     'wast': ['disgust', 'negative'], 'wateri': ['negative'], 'weaken': ['negative'],
                     'weak': ['fear', 'negative', 'sadness'], 'wearili': ['negative', 'sadness'],
                     'weari': ['negative', 'sadness'], 'weed': ['negative', 'sadness'], 'weighti': ['fear'],
                     'welcom': ['joy', 'positive'], 'whimsic': ['joy'], 'whiski': ['negative'],
                     'wholesom': ['positive', 'trust'], 'wick': ['fear', 'negative'],
                     'wilder': ['anticipation', 'fear', 'sadness'],
                     'wildfir': ['fear', 'negative', 'sadness', 'surprise'], 'will': ['anger', 'negative', 'sadness'],
                     'willing': ['positive'], 'wimpi': ['anger', 'disgust', 'fear', 'negative', 'sadness'],
                     'winc': ['anger', 'disgust', 'fear', 'negative', 'sadness'], 'windfal': ['positive'],
                     'win': ['anticipation', 'disgust', 'joy', 'positive', 'sadness', 'surprise', 'trust'],
                     'wish': ['anticipation'], 'witti': ['joy', 'positive'],
                     'woefulli': ['disgust', 'negative', 'sadness'], 'wonder': ['joy', 'positive', 'surprise', 'trust'],
                     'work': ['positive'], 'worri': ['negative', 'sadness'], 'wors': ['fear', 'negative', 'sadness'],
                     'worsen': ['disgust', 'negative', 'sadness'], 'worthi': ['positive', 'trust'],
                     'wrangl': ['anger', 'disgust', 'fear', 'negative', 'sadness'], 'wrestl': ['negative'],
                     'wrinkl': ['sadness'], 'wrongdo': ['anger', 'disgust', 'negative', 'sadness'], 'wri': ['negative'],
                     'yearn': ['anticipation', 'joy', 'negative', 'positive', 'trust'], 'yellow': ['negative'],
                     'zani': ['surprise']}
